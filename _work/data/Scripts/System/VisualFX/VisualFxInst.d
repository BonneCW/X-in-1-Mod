...
instance SPELLFX_ZORNADANOS(CFX_BASE_PROTO)
{
...
instance SPELLFX_ZORNADANOS_KEY_INIT(C_PARTICLEFXEMITKEY)
{
};

instance SPELLFX_ZORNADANOS_KEY_CAST(C_PARTICLEFXEMITKEY)
{
	emtrjmode_s = "TARGET";
	emtrjeasevel = 2500;
...
instance SPELLFX_ZORNADANOS_TRAIL(CFX_BASE_PROTO)
{
	emtrjeasevel = 800;
...
instance SPELLFX_ZORNADANOS_TRAIL_COLLIDE(C_PARTICLEFXEMITKEY)
{
	emtrjeasevel = 1e-006;
};

instance SPELLFX_ZORNADANOS_COLLIDE(CFX_BASE_PROTO)
{
...
instance SPELLFX_ZORNADANOS_COLLIDEDYNFX(CFX_BASE_PROTO)
{
	emtrjoriginnode = "BIP01";
	visname_s = "MFX_DESTROYUNDEAD_COLLIDE";
	emtrjmode_s = "FIXED";
...
instance spellFX_Summoner(CFx_Base_Proto)
{
		visname_S 			= "MFX_Heal_INIT";
		emtrjmode_s 		= "FIXED";
		emTrjOriginNode 	= "ZS_RIGHTHAND";
		...
		instance spellFX_Summoner_KEY_INVEST_1	(C_ParticleFXEmitKey)
		{
			visname_S		= "MFX_HEAL_CAST";
			emCreateFXID	= "spellFX_Summoner_LEFTHAND";
		};

		instance spellFX_Summoner_KEY_CAST	 	(C_ParticleFXEmitKey)
		{
			// Noki: wieder aktiviert, da er an der Hand bliebt
			pfx_ppsisloopingChg = 1;
			emCreateFXID		= "spellFX_Summoner_ORIGIN";
};

instance spellFX_Summoner_ORIGIN	(CFx_Base_Proto)
{
		visname_S 			= "MFX_Heal_HEAVENLIGHT";
		emTrjOriginNode 	= "BIP01";
		visAlpha			= 1;
...
instance spellFX_Summoner_LEFTHAND	(CFx_Base_Proto)
{
		visname_S 			= "MFX_HEAL_CAST";
		emTrjOriginNode 	= "ZS_LEFTHAND";
		visAlpha			= 1;
		...
		INSTANCE spellFX_Summoner_LEFTHAND_KEY_INIT (C_ParticleFXEmitKey)
		{
				lightrange 				= 0.001;
		};

		INSTANCE spellFX_Summoner_LEFTHAND_KEY_CAST (C_ParticleFXEmitKey)
		{
				lightrange 				= 150;
};
///   													XXXXXXXXXXXXXXXXXXXXXXXXXX
...
instance spellFX_Blutopfer_TARGET	(CFx_Base_Proto)  //FLASH
{
	visname_S 			= "MFX_ENERGYBALL_TARGET";
...
///   													XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
///   													XXXXXXXXX  A L T E R N XXXXXXXXX
///   													XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
...
INSTANCE spellFX_Giftanschlag_COLLIDE_KEY_INVEST_1	(C_ParticleFXEmitKey)  {	visname_S 	= "MFX_Thunderball_Collide1";		sfxid	= "MFX_Thunderball_Collide1";		};
INSTANCE spellFX_Giftanschlag_COLLIDE_KEY_INVEST_2	(C_ParticleFXEmitKey)  {	visname_S 	= "MFX_Thunderball_Collide2";		sfxid	= "MFX_Thunderball_Collide2";		};
INSTANCE spellFX_Giftanschlag_COLLIDE_KEY_INVEST_3	(C_ParticleFXEmitKey)  {	visname_S 	= "MFX_Thunderball_Collide3";		sfxid	= "MFX_Thunderball_Collide3";		};
INSTANCE spellFX_Giftanschlag_COLLIDE_KEY_INVEST_4	(C_ParticleFXEmitKey)  {	visname_S 	= "MFX_Thunderball_Collide4";		sfxid	= "MFX_Thunderball_Collide4";		};


///   													XXXXXXXXXXXXXXXXX
///   													XX  W A H N S I N N  XX
///   													XXXXXXXXXXXXXXXXX
...
INSTANCE SLOW_MOTION2(CFx_Base_Proto)
{
	// userstring 0: world  time scaler
	// userstring 1: player time scaler
 	...
 	userString[1]     	= "1.0";
 	emFxCreate_s		= "FOV_MORPH2";
	emFXLifeSpan    	= 10;						// achtung, zeitdauer ist hier skaliert mit dem time scaler
	emFXTriggerDelay	= 3;						// achtung, zeitdauer ist hier skaliert mit dem time scaler
};
...
instance SPELLFX_GHOST(CFX_BASE_PROTO)
{
	visname_s = "MFX_ghost_INIT";
	emtrjmode_s = "FIXED";
	emtrjoriginnode = "ZS_RIGHTHAND";
};

instance SPELLFX_GHOST_KEY_INVEST_1(C_PARTICLEFXEMITKEY)
{
	visname_s = "MFX_ghost_CAST";
	emcreatefxid = "spellFX_ghost_LEFTHAND";
};

instance SPELLFX_GHOST_KEY_CAST(C_PARTICLEFXEMITKEY)
{
	pfx_ppsisloopingchg = 1;
	emcreatefxid = "spellFX_ghost_ORIGIN";
};

instance SPELLFX_GHOST_ORIGIN(CFX_BASE_PROTO)
{
	visname_s = "MFX_ghost_HEAVENLIGHT";
	emtrjoriginnode = "BIP01";
	visalpha = 1;
	emtrjmode_s = "FIXED";
	sfxid = "MFX_ghost_CAST";
	sfxisambient = 1;
};

instance SPELLFX_GHOST_LEFTHAND(CFX_BASE_PROTO)
{
	visname_s = "MFX_ghost_CAST";
	emtrjoriginnode = "ZS_LEFTHAND";
	visalpha = 1;
...
instance SPELLFX_GHOST_LEFTHAND_KEY_INIT(C_PARTICLEFXEMITKEY)
{
	lightrange = 0.001;
};

instance SPELLFX_GHOST_LEFTHAND_KEY_CAST(C_PARTICLEFXEMITKEY)
{
	lightrange = 150;
};

instance SPELLFX_AMOK(CFX_BASE_PROTO)
{
	visname_s = "MFX_Heal_INIT";
	emtrjmode_s = "FIXED";
	emtrjoriginnode = "ZS_RIGHTHAND";
...
instance SPELLFX_AMOK_KEY_INVEST_1(C_PARTICLEFXEMITKEY)
{
	visname_s = "MFX_HEAL_CAST";
	emcreatefxid = "spellFX_amok_LEFTHAND";
};

instance SPELLFX_AMOK_KEY_CAST(C_PARTICLEFXEMITKEY)
{
	pfx_ppsisloopingchg = 1;
	emcreatefxid = "spellFX_amok_ORIGIN";
};

instance SPELLFX_AMOK_ORIGIN(CFX_BASE_PROTO)
{
	visname_s = "MFX_amok_HEAVENLIGHT";
	emtrjoriginnode = "BIP01";
	visalpha = 1;
	emtrjmode_s = "FIXED";
	sfxid = "MFX_amok_CAST";
...
instance SPELLFX_AMOK_LEFTHAND(CFX_BASE_PROTO)
{
	visname_s = "MFX_amok_CAST";
	emtrjoriginnode = "ZS_LEFTHAND";
	visalpha = 1;
	emtrjmode_s = "FIXED";
	lightpresetname = "AURA";
...
instance SPELLFX_AMOK_LEFTHAND_KEY_INIT(C_PARTICLEFXEMITKEY)
{
	lightrange = 0.001;
};

instance SPELLFX_AMOK_LEFTHAND_KEY_CAST(C_PARTICLEFXEMITKEY)
{
	lightrange = 150;
};

instance SPELLFX_EARTH(CFX_BASE_PROTO)
{
	visname_s = "MFX_ArmyOfDarkness_INIT";
	visalpha = 1;
	emtrjmode_s = "FIXED";
...
instance SPELLFX_EARTH_KEY_OPEN(C_PARTICLEFXEMITKEY)
{
	lightrange = 0.01;
};

instance SPELLFX_EARTH_KEY_INIT(C_PARTICLEFXEMITKEY)
{
	lightrange = 0.01;
};

instance SPELLFX_EARTH_KEY_INVEST_1(C_PARTICLEFXEMITKEY)
{
	lightrange = 200;
};

instance SPELLFX_EARTH_KEY_CAST(C_PARTICLEFXEMITKEY)
{
	emcreatefxid = "FX_EarthQuake";
	emcreatefxid = "spellFX_SummonCreature_ORIGIN";
	emcreatefxid = "FX_EarthQuake";
...
instance SPELLFX_VLIGHT(CFX_BASE_PROTO)
{
	visname_s = "MFX_vLIGHT_INIT";
	visalpha = 1;
	emtrjmode_s = "FIXED";
	emtrjoriginnode = "ZS_RIGHTHAND";
	emfxcreate_s = "spellFX_vLight_ACTIVE";
	emfxcreatedowntrj = 1;
};

instance SPELLFX_VLIGHT_KEY_CAST(C_PARTICLEFXEMITKEY)
{
	pfx_ppsisloopingchg = 1;
};

instance SPELLFX_VLIGHT_ACTIVE(CFX_BASE_PROTO)
{
	visname_s = "";
	visalpha = 1;
	emtrjmode_s = "FOLLOW TARGET";
	...
	emtrjtargetrange = 1.2;
	emtrjtargetelev = 89;
	lightpresetname = "JUSTRED";
};

instance SPELLFX_VLIGHT_ACTIVE_KEY_OPEN(C_PARTICLEFXEMITKEY)
{
	lightrange = 0.01;
};

instance SPELLFX_VLIGHT_ACTIVE_KEY_INIT(C_PARTICLEFXEMITKEY)
{
	lightrange = 0.01;
};

instance SPELLFX_VLIGHT_ACTIVE_KEY_CAST(C_PARTICLEFXEMITKEY)
{
	visname_s = "MFX_VLIGHT_ORIGIN";
	lightrange = 2500;
	sfxid = "MFX_Light_CAST";
	sfxisambient = 1;
	emtrjeasevel = 1400;
...
instance SPELLFX_GHOSTSPELL(CFX_BASE_PROTO)
{
	visname_s = "MFX_PalHolyBolt_INIT";
	emtrjmode_s = "FIXED";
	emtrjoriginnode = "ZS_RIGHTHAND";
	...
	emactioncollstat_s = "COLLIDE CREATE";
	emactioncolldyn_s = "COLLIDE CREATEONCE";
	emfxcollstat_s = "spellFX_ghostspell_COLLIDE";
	emfxcolldyn_s = "spellFX_ghostspell_COLLIDEDYNFX";
	emtrjtargetrange = 20;
	emtrjtargetelev = 0;
	emtrjdynupdatedelay = 20000;
};

instance SPELLFX_GHOSTSPELL_KEY_INIT(C_PARTICLEFXEMITKEY)
{
	visname_s = "MFX_PalHolyBolt_INIT";
	scaleduration = 0.5;
};

instance SPELLFX_GHOSTSPELL_KEY_CAST(C_PARTICLEFXEMITKEY)
{
	visname_s = "MFX_PalHolyBolt_CAST";
	emtrjmode_s = "TARGET";
	emtrjeasevel = 1600;
...
instance SPELLFX_GHOSTSPELL_KEY_COLLIDE(C_PARTICLEFXEMITKEY)
{
	pfx_flygravity_s = "0 0.0002 0";
	emtrjeasevel = 1e-006;
	emcheckcollision = 0;
...
instance SPELLFX_GHOSTSPELL_COLLIDE(CFX_BASE_PROTO)
{
	visname_s = "MFX_PalHolyBolt_Collide";
	visalpha = 1;
	emtrjmode_s = "FIXED";
...
instance SPELLFX_GHOSTSPELL_COLLIDEDYNFX(CFX_BASE_PROTO)
{
	visname_s = "MFX_PalHolyBolt_Collide";
	visalpha = 1;
	emtrjmode_s = "FIXED";
...
instance SPELLFX_SOUL(CFX_BASE_PROTO)
{
	visname_s = "MFX_soul_INIT";
	emtrjmode_s = "FIXED";
	emtrjoriginnode = "ZS_RIGHTHAND";
	emtrjtargetnode = "BIP01 FIRE";
	emtrjloopmode_s = "NONE";
	...
	emactioncollstat_s = "COLLIDE CREATE";
	emactioncolldyn_s = "COLLIDE CREATEONCE";
	emfxcollstat_s = "spellFX_soul_COLLIDE";
	emfxcolldyn_s = "spellFX_soul_COLLIDEDYNFX";
	emtrjtargetrange = 20;
	emtrjtargetelev = 0;
	emtrjdynupdatedelay = 20000;
};

instance SPELLFX_SOUL_KEY_INIT(C_PARTICLEFXEMITKEY)
{
	visname_s = "MFX_soul_INIT";
};

instance SPELLFX_SOUL_KEY_CAST(C_PARTICLEFXEMITKEY)
{
	visname_s = "MFX_soul_CAST";
	emtrjmode_s = "TARGET";
	emtrjeasevel = 800;
	sfxid = "MFX_soul_Cast";
	sfxisambient = 1;
...
instance SPELLFX_SOUL_COLLIDE(CFX_BASE_PROTO)
{
	emtrjoriginnode = "BIP01";
	visname_s = "MFX_soul_COLLIDE";
	emtrjmode_s = "FIXED";
	emtrjdynupdatedelay = 0;
	lightpresetname = "AURA";
	sfxid = "MFX_soul_COLLIDE";
	sfxisambient = 1;
};

instance SPELLFX_SOUL_COLLIDEDYNFX(CFX_BASE_PROTO)
{
	emtrjoriginnode = "BIP01";
	visname_s = "MFX_soul_COLLIDE";
	emtrjmode_s = "FIXED";
...
instance SPELLFX_SUMMONWARG(CFX_BASE_PROTO)
{
	visname_s = "MFX_ArmyOfDarkness_INIT";
	visalpha = 1;
	emtrjmode_s = "FIXED";
...
instance SPELLFX_SUMMONWARG_KEY_OPEN(C_PARTICLEFXEMITKEY)
{
	lightrange = 0.01;
};

instance SPELLFX_SUMMONWARG_KEY_INIT(C_PARTICLEFXEMITKEY)
{
	lightrange = 0.01;
};

instance SPELLFX_SUMMONWARG_KEY_INVEST_1(C_PARTICLEFXEMITKEY)
{
	lightrange = 200;
	emcreatefxid = "FX_EarthQuake";
};

instance SPELLFX_SUMMONWARG_KEY_CAST(C_PARTICLEFXEMITKEY)
{
	emcreatefxid = "spellFX_SummonCreature_ORIGIN";
	pfx_ppsisloopingchg = 1;
};

instance SPELLFX_SUMMON3WARG(CFX_BASE_PROTO)
{
	visname_s = "MFX_ArmyOfDarkness_INIT";
	visalpha = 1;
	emtrjmode_s = "FIXED";
...
instance SPELLFX_SUMMON3WARG_KEY_OPEN(C_PARTICLEFXEMITKEY)
{
	lightrange = 0.01;
};

instance SPELLFX_SUMMON3WRAG_KEY_INIT(C_PARTICLEFXEMITKEY)
{
	lightrange = 0.01;
};

instance SPELLFX_SUMMON3WARG_KEY_INVEST_1(C_PARTICLEFXEMITKEY)
{
	lightrange = 200;
	emcreatefxid = "FX_EarthQuake";
};

instance SPELLFX_SUMMON3WARG_KEY_CAST(C_PARTICLEFXEMITKEY)
{
	emcreatefxid = "spellFX_SummonCreature_ORIGIN";
	pfx_ppsisloopingchg = 1;
};

instance SPELLFX_SUMMONSHADOW(CFX_BASE_PROTO)
{
	visname_s = "MFX_ArmyOfDarkness_INIT";
	visalpha = 1;
	emtrjmode_s = "FIXED";
...
instance SPELLFX_SUMMONSHADOW_KEY_OPEN(C_PARTICLEFXEMITKEY)
{
	lightrange = 0.01;
};

instance SPELLFX_SUMMONSHADOW_KEY_INIT(C_PARTICLEFXEMITKEY)
{
	lightrange = 0.01;
};

instance SPELLFX_SUMMONSHADOW_KEY_INVEST_1(C_PARTICLEFXEMITKEY)
{
	lightrange = 200;
	emcreatefxid = "FX_EarthQuake";
};

instance SPELLFX_SUMMONSHADOW_KEY_CAST(C_PARTICLEFXEMITKEY)
{
	emcreatefxid = "spellFX_SummonCreature_ORIGIN";
	pfx_ppsisloopingchg = 1;
};

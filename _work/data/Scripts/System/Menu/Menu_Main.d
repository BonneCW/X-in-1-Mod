...
instance MENUITEM_MAIN_NEWGAME(C_MENU_ITEM_DEF) 
{
	...
	text[0]		= "X in 1 MOD beginnen";
	text[1]		= "X Abenteuer in einem beginnen?";  // Kommentar
...
INSTANCE MENUITEM_MAIN_SAVEGAME_LOAD(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Zeitreise";
	text[1]		=	"Zurück zu einem gesicherten Zeitpunkt.";  // Kommentar
...
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Zeitpunkt sichern";
	text[1]		= "Diesen Zeitpunkt für eine Zeitreise sichern.";  // Kommentar
...
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Weitere Wesen quälen";
	text[1]		=   "Back to action.";  // Kommentar
...
INSTANCE MENUITEM_MAIN_EXIT(C_MENU_ITEM_DEF) 
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "MOD beenden";
	text[1]		= "Spiel beenden";  // Kommentar

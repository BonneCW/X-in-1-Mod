...
FUNC VOID B_ENTER_NEWWORLD_Kapitel_3 ()
{
	if (EnterNW_Kapitel3 == FALSE)
	{
		...
		Wld_InsertNpc (None_9005_Leonard, "NW_TAVERNE_GREGSBENCH");
		...
		if ((hero.guild == GIL_MIL) || (hero.guild == GIL_PAL) || (hero.guild == GIL_BAD))
		{
		...
		if ((hero.guild == GIL_KDF) || (hero.guild == GIL_OUT))
		{
		...
		else if ((hero.guild == GIL_KDF) || (hero.guild == GIL_OUT))
		{
...
FUNC VOID B_ENTER_NEWWORLD_Kapitel_4 ()
{
	if (EnterNW_Kapitel4 == FALSE)
	{
		...
		Wld_InsertItem	(ItAt_DragonEgg_MIS , "FP_ROAM_XARDAS_CAVE_13"); 	
		...
		if ((hero.guild == GIL_PAL) || (hero.guild == GIL_OUT) || (hero.guild == GIL_NONE))
		{
		...
		if ((hero.guild == GIL_KDF) || (hero.guild == GIL_DJG) || (hero.guild == GIL_OUT) || (hero.guild == GIL_NONE))
		{
		...
		if ((hero.guild == GIL_DJG) || (hero.guild == GIL_OUT) || (hero.guild == GIL_NONE))
		{
		...
		if ((hero.guild == GIL_KDF) || (hero.guild == GIL_OUT) || (hero.guild == GIL_NONE))
		{
...
FUNC VOID B_ENTER_NEWWORLD_Kapitel_5 ()
{
	...
	if (Krieg_wechselt && kennt_Steinkreis)
	  {
	    Wld_InsertNpc(Bad_9006_Krieg, "NW_LITTLESTONEHENDGE");
	    B_StartOtherRoutine(Bad_9006_Krieg, "NW");
	    Krieg_wechselt = FALSE;
	  };
	if (Tod_wechselt && kennt_Steinkreis)
	  {
	    Wld_InsertNpc(Bad_9009_Tod, "NW_LITTLESTONEHENDGE");
	    B_StartOtherRoutine(Bad_9009_Tod, "NW");
	    Tod_wechselt = FALSE;
	  }; 
};

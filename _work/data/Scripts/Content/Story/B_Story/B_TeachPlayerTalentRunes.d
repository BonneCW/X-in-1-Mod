...
func int B_TeachPlayerTalentRunes (var C_NPC slf, var C_NPC oth, var int spell)
{
	...
	if (spell == SPL_SUMMONICEWOLF)
	{
		PLAYER_TALENT_RUNES[106] = TRUE;
		CreateInvItems (ScrollTrader, itsc_sumicewolf, 1);
		B_LogEntry (TOPIC_TalentRunes, "Zutaten für die Rune ´EISWOLF RUFEN´: 1 Wolfsfell und 1 Gletscherquartz.");
	};
	if (spell == SPL_SUMMONICEGOLEM)
	{
		PLAYER_TALENT_RUNES[107] = TRUE;
		CreateInvItems (ScrollTrader, itsc_sumicegol, 1);
		CreateInvItems (ScrollTrader, ItAt_IceGolemHeart, 1);

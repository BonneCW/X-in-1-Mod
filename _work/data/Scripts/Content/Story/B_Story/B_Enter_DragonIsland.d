...
FUNC VOID STARTUP_NEWWORLD_PART_DRAGON_ISLAND_01 ()
{
	...
	//----- Dunkelkrieger im Vorgebiet (Ork- und Echsenmenschen-Gebiet)
};
...
//----- Die Crew -----
	...
	STARTUP_NEWWORLD_PART_DRAGON_FINAL_01();
	 ...
	 && (dog_follow==TRUE)
        {
	Wld_InsertNpc (DOG_DI   ,"SHIP_DECK_09");
	DOG_DI.attribute[ATR_STRENGTH]=D_STR;
	DOG_DI.attribute[ATR_HITPOINTS_MAX]=D_HP;
	DOG_DI.attribute[ATR_HITPOINTS]=D_HP;
	DOG_DI.protection	[PROT_BLUNT]		=D_RST_blunt;
	DOG_DI.protection	[PROT_EDGE]		=D_RST_edge;
	DOG_DI.protection	[PROT_POINT]		=D_RST_point;
	DOG_DI.protection	[PROT_FIRE]		=D_RST_fire;
	DOG_DI.protection	[PROT_FLY]		=D_RST_fly;
	DOG_DI.protection	[PROT_MAGIC]		=D_RST_magic;
	};
...
FUNC VOID INIT_DRAGONISLAND ()
{
	...
	&& (DM_DI_Spawned == FALSE)
	{
		Wld_InsertNpc (Bad_9012_Leiche, "DI_ORKAREA_04");
		Wld_InsertNpc (Bad_9013_Leiche, "DI_ORKAREA_05");
		Wld_InsertNpc (Bad_9014_Leiche, "DI_ORKAREA_TROLL");
		Wld_InsertNpc (Bad_9015_Leiche, "DI_ORKAREA_15");
		Wld_InsertNpc (Bad_9016_Leiche, "DI_DRACONIANAREA_04");
		B_KillNpc     (Bad_9012_Leiche);
		B_KillNpc     (Bad_9013_Leiche);
		B_KillNpc     (Bad_9014_Leiche);
		B_KillNpc     (Bad_9015_Leiche);
		B_KillNpc     (Bad_9016_Leiche);

		Wld_InsertNpc (Bad_9018_Knut, "DI_SHIP_02");
		Wld_InsertNpc (Bad_9019_Hugo, "DI_SHIP_03");
		Wld_InsertNpc (Bad_9020_Erwin, "DI_SHIP_04");

		Wld_InsertNpc (Bad_9017_Leiche, "WP_DRAGONISLAND_UNDEAD_LORDROOM_01");
		B_KillNpc     (Bad_9017_Leiche);
		Wld_InsertNpc (Bad_9021_Waffenmeister, "WP_DRAGONISLAND_UNDEAD_LAB_01");

		Wld_InsertNpc (BAD_90100_LAP_DI, "SHIP_DECK_10");

...
//******************************************************************	
  ...
  // Dunkle Magie
  var C_NPC Trd_Waffenmeister; Trd_Waffenmeister = Hlp_GetNpc (Bad_9021_Waffenmeister);
...
//********************************************************************
	...
	{
	  //Dunkle Magie
	  if (Hlp_GetInstanceID (slf) == Hlp_GetInstanceID (Trd_Waffenmeister)) {B_ClearJunkTradeInv(slf); B_GiveTradeInv_Waffenmeister (slf);};
	...
	{
	  //Dunkle Magie
	  if Hlp_GetInstanceID (slf) == Hlp_GetInstanceID (Trd_Waffenmeister) {B_ClearDeadTrader (slf);};

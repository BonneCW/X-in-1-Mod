...
instance DIA_Albrecht_runeherausrufezeichen		(C_INFO)
{
	npc		 	 = 	PAL_202_Albrecht;
	nr			 =  1;
	condition	 = 	DIA_Albrecht_runeherausrufezeichen_Condition;
	information	 = 	DIA_Albrecht_runeherausrufezeichen_Info;
	permanent    =  FALSE;
	description	 =  "Ich brauche eine grosse Wundheilungsrune";
};

func int DIA_Albrecht_runeherausrufezeichen_Condition ()
{	
	if (Npc_KnowsInfo (other,DIA_Vlk_60000_Nor_FINALEQUIPPMENT))
	{
		return TRUE;
	};
};
func void DIA_Albrecht_runeherausrufezeichen_Info ()
{
	AI_Output (other, self, "DIA_Albrecht_runeherausrufezeichen_15_00"); //Ich brauche eine grosse Wundheilungsrune
	AI_Output (self, other, "DIA_Albrecht_runeherausrufezeichen_03_01"); //Bist du bescheuert? Nur ein Paladin darf eine der heiligen Runen besitzen. Und ich werde meine Pflicht nich verletzen. Ich werde meinen Versprechen gegenüber Innos einhalten!
	AI_Output (self, other, "DIA_Albrecht_runeherausrufezeichen_03_02"); //(leise) 7000 Gold
B_LogEntry (TOPIC_finale,"Albrecht will 7000 Gold für eine grosse Wundheilungsrune");


};

instance DIA_Albrecht_runeherausrufezeichengh		(C_INFO)
{
	npc		 	 = 	PAL_202_Albrecht;
	nr			 =  1;
	condition	 = 	DIA_Albrecht_runeherausrufezeichengh_Condition;
	information	 = 	DIA_Albrecht_runeherausrufezeichengh_Info;
	permanent    =  FALSE;
	description	 =  "grosse Wundheilungrune (7000 Gold)";
};

func int DIA_Albrecht_runeherausrufezeichengh_Condition ()
{	
	if (Npc_KnowsInfo (other,DIA_Albrecht_runeherausrufezeichen))
        && ( Npc_HasItems(other,itmi_gold) >= 7000) 
	{
		return TRUE;
	};
};
func void DIA_Albrecht_runeherausrufezeichengh_Info ()
{
	AI_Output (other, self, "DIA_Albrecht_runeherausrufezeichengh_15_00"); //Hier hast du das Gold.
	AI_Output (self, other, "DIA_Albrecht_runeherausrufezeichengh_03_01"); //Pssst!!
	AI_Output (self, other, "DIA_Albrecht_runeherausrufezeichengh_03_02"); //Hier nimm!
B_LogEntry (TOPIC_finale,"Albrecht hat mir eine grosse Wundheilungrune verkauft");

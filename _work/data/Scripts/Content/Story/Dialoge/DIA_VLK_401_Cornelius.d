...
FUNC VOID DIA_Cornelius_DontBelieveYou_Info()
{
	...
	{
		Info_AddChoice (DIA_Cornelius_DontBelieveYou,"Ich könnte dich für lange Zeit in eine Welt voller Schmerzen verbannen.",DIA_Cornelius_DontBelieveYou_DarkMage);
	};
};

FUNC VOID DIA_Cornelius_DontBelieveYou_DarkMage ()
{
	AI_Output (other,self ,"DIA_Cornelius_DontBelieveYou_DarkMage_15_00"); //Ich könnte dich für lange Zeit in eine Welt voller Schmerzen verbannen.
	AI_Output (self ,other,"DIA_Cornelius_DontBelieveYou_DarkMage_13_01"); //(kreidebleich) Was meinst du damit?
	AI_Output (other,self ,"DIA_Cornelius_DontBelieveYou_DarkMage_15_02"); //Nun, wir haben Möglichkeiten, die Wahrheit zu erfahren. Schmerzhafte Möglichkeiten.
	AI_Output (self ,other,"DIA_Cornelius_DontBelieveYou_DarkMage_13_03"); //Nein, bitte nicht. Ich werde alles sagen, was du willst.

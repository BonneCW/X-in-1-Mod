...
instance DIA_Harad_erzstahl		(C_INFO)
{
	npc		 	 = 	VLK_412_Harad;
	nr           = 	8;
	condition	 = 	DIA_Harad_erzstahl_Condition;
	information	 = 	DIA_Harad_erzstahl_Info;
	permanent	 = 	FALSE;
	description	 = 	"Ich brauche 10 Stangen Erzstangen für Nor";
};

func int DIA_Harad_erzstahl_Condition ()
{
	if 	(Npc_KnowsInfo (other,DIA_Vlk_60000_Nor_rt)) 
  	{
  		return TRUE;
  	};
};

func void DIA_Harad_erzstahl_Info ()
{
	AI_Output (other,self ,"DIA_Harad_erzstahl_15_00"); //Ich brauche 10 Stangen Erzstangen für Nor
	AI_Output (self ,other,"DIA_Harad_erzstahl_12_01"); //Ich weiss. Nor hat aber noch nicht bezahlt. Die Stangen kosten 2000 Goldstücke.
 
};

instance DIA_Harad_erzstahlk		(C_INFO)
{
	npc		 	 = 	VLK_412_Harad;
	nr           = 	8;
	condition	 = 	DIA_Harad_erzstahlk_Condition;
	information	 = 	DIA_Harad_erzstahlk_Info;
	permanent	 = 	FALSE;
	description	 = 	"Erzstangen kaufen (2000 Gold)";
};

func int DIA_Harad_erzstahlk_Condition ()
{
	if 	(Npc_KnowsInfo (other,DIA_Harad_erzstahl)) 
...
func void DIA_Harad_erzstahlk_Info ()
{
	AI_Output (other,self ,"DIA_Harad_erzstahlk_15_00"); //Hier hast du das Geld
	AI_Output (self ,other,"DIA_Harad_erzstahlk_12_01"); //Danke. Und hier sind die Erzstahlstangen.
	B_GiveInvItems ( other, self, itmi_gold, 2000);
	B_GiveInvItems ( self, other, ItMi_ORESTEEL, 10);
};

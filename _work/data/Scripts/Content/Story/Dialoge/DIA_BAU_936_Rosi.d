...
func void DIA_Rosi_HILFE_Info ()
{
	...
	if ((hero.guild == GIL_MIL) || (hero.guild == GIL_PAL) || (hero.guild == GIL_BAD) || (hero.guild == GIL_BAU))
	{
...
func int DIA_Rosi_ANGEKOMMEN_Condition ()
{
	...
	&& (MIS_bringRosiBackToSekob != LOG_SUCCESS)
	&& (Rosi_FleeFromSekob_Kap5 == TRUE)
	&& (((Npc_GetDistToWP(self,"CITY2")<6000)
	&& ((hero.guild == GIL_PAL) || (hero.guild == GIL_Bad) || (hero.guild == GIL_BAU)))
	|| ((Npc_GetDistToWP(self,"NW_BIGFARM_KITCHEN_02")<6000)
 	&& (hero.guild == GIL_DJG))
	|| ((Npc_GetDistToWP(self,"KLOSTER")<6000)
	&& (hero.guild == GIL_KDF)))
	{
		return TRUE;
	};

...
//------------------ Addon -------------------
	...
	if ((PLAYER_TALENT_RUNES[78] == FALSE) && (hero.guild == GIL_KDW))
	{
		Info_AddChoice (DIA_Addon_Nefarius_ADW_Runen, B_BuildLearnString (NAME_SPL_SUMMONICEWOLF, B_GetLearnCostTalent (other, NPC_TALENT_RUNES, SPL_SUMMONICEWOLF)), dia_addon_nefarius_adw_runen_circle_3_spl_summonicewolf);
	};	
};
...
FUNC VOID DIA_Addon_Nefarius_ADW_Runen_4()
{
	...
	if ((PLAYER_TALENT_RUNES[79] == FALSE) && (hero.guild == GIL_OUT))
	{
		Info_AddChoice (DIA_Addon_Nefarius_ADW_Runen, B_BuildLearnString (NAME_SPL_SUMMONICEGOLEM, B_GetLearnCostTalent (other, NPC_TALENT_RUNES, SPL_SUMMONICEGOLEM)), dia_addon_nefarius_adw_runen_circle_4_spl_summonicegolem);
	};
};
...
func void dia_addon_nefarius_adw_runen_circle_3_spl_summonicewolf()
{
	B_TeachPlayerTalentRunes (self, other, SPL_SUMMONICEWOLF);
};

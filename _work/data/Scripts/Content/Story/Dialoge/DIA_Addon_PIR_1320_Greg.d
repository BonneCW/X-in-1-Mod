...
FUNC VOID DIA_Addon_Greg_AboutCanyon_RazorsDead()
{
	...
	AI_Output(self, other, "DIA_Addon_Greg_AboutCanyon_RazorsDead_01"); //Aber anscheinend hat ein Rudel von diesen verdammten Steinpumas nur darauf gewartet, dass wir die Razor für sie aus dem Weg räumen.
	AI_Output(other, self, "DIA_Addon_Greg_AboutCanyon_RazorsDead_02"); //Soll ich die auch noch killen?
	AI_Output(self, other, "DIA_Addon_Greg_AboutCanyon_RazorsDead_03"); //Für heute hast du schon genug gemacht.
	Wld_InsertNpc(StonePuma, "ADW_CANYON_PATH_TO_LIBRARY_12AA");
	Wld_InsertNpc(StonePuma, "ADW_CANYON_PATH_TO_LIBRARY_12AA");
	Wld_InsertNpc(StonePuma, "ADW_CANYON_PATH_TO_LIBRARY_12AA");
	Wld_InsertNpc(StonePuma, "ADW_CANYON_PATH_TO_LIBRARY_12AA");
	Wld_InsertNpc(StonePuma, "ADW_CANYON_PATH_TO_LIBRARY_12AA");
	Wld_InsertNpc(StonePuma, "ADW_CANYON_PATH_TO_LIBRARY_06");

...
instance DIA_Addon_AlligatorJack_Wo (C_Info)
{
  npc = PIR_1352_Addon_AlligatorJack;
  nr = 15;
  condition = DIA_Addon_AlligatorJack_Wo_Condition;
  information = DIA_Addon_AlligatorJack_Wo_Info;
  permanent = FALSE;
  important = FALSE;
  description = "Wo kann man denn hier in der Gegend Alligatoren finden?";
};

func int DIA_Addon_AlligatorJack_Wo_Condition ()
{
  if (Npc_KnowsInfo(other, DIA_Addon_AlligatorJack_WasJagen))
    {
      return true;
    };
  return false;
...
func void DIA_Addon_AlligatorJack_Wo_Info ()
{
  AI_Output(other, self, "DIA_Addon_AlligatorJack_Wo_01"); //Wo kann man denn hier in der Gegend Alligatoren finden?
  AI_Output(self, other, "DIA_Addon_AlligatorJack_Wo_02"); //Mhh (nachdenklich) drüben im Sumpf sind meistenst welche.
  AI_Output(self, other, "DIA_Addon_AllogatorJack_Wo_03"); //Aber ich war lange nicht mehr da, die Banditen, du weißt schon.
  AI_Output(self, other, "DIA_Addon_AllogatorJack_Wo_04"); //Ansonsten treiben sich auch manchmal welche im Talkessel rum.
  Wld_InsertNpc(Alligator, "ADW_PATH_TO_LOCH_01");
  Wld_InsertNpc(Alligator, "ADW_SWAMP_03");
  Wld_InsertNpc(Alligator, "ADW_SENAT_05");
  Wld_InsertNpc(Alligator, "ADW_SWAMP_HILLS_DOWN_06");
  Wld_InsertNpc(Alligator, "ADW_PIRATECAMP_WATERHOLE_09");
  Wld_InsertNpc(Alligator, "ADW_PIRATECAMP_INSEL_01");
  Wld_InsertNpc(Alligator, "ADW_PIRATECAMP_WATERHOLE_07");
};

...
func void dia_niclas_ritualmesser_info()
{
	...
	AI_Output (other, self, "Dia_Niclas_ritualmesser_02");	//Orlan meinte, er hätte es an einen Jäger verkauft, dessen Name mit 'N' anfängt.
	AI_Output (self, other, "Dia_Niclas_ritualmesser_03");	//Ja, mein Name fängt mit 'N' an und ich habe ein wertvolles Messer von Orlan.
...
func void dia_niclas_ritualmesser_good()
{
	...
	AI_Output (self, other, "Dia_Niclas_ritualmesser_Good_01");	//Abkaufen nicht direkt, aber ich könnte es gegen bessere Ausrüstung tauschen.
	AI_Output (self, other, "Dia_Niclas_ritualmesser_Good_02");	//Bring mir einfach einen "Jagdbogen", dann bekommst du dein Messer.
	AI_Output (other, self, "Dia_Niclas_ritualmesser_Good_03");	//Und was willst du hier draußen ohne Messer machen?
	AI_Output (self, other, "Dia_Niclas_ritualmesser_Good_04");	//Ich habe natürlich ein Ersatzmesser und ein guter Bogen ist für mich momentan wichtiger.
	Info_ClearChoices (dia_niclas_ritualmesser);
	MIS_NICLAS_BOGEN = TRUE;
	B_LogEntry (DAS_BLUTRITUAL, "Ich habe den Jäger mit dem Ritualmesser gefunden, er heißt Niclas und will das Messer gegen einen 'Jagdbogen' tauschen.");
};

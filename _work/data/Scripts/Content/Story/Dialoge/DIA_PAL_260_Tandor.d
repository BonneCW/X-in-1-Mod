...
instance DIA_Tandor_Nordmann		(C_INFO)
{
	npc		= PAL_260_Tandor;
	nr		= 2;
	condition	= DIA_Tandor_Nordmann_Condition;
	information	= DIA_Tandor_Nordmann_Info;
	permanent 	= 0;
	description  	= "Ich habe gehört, du hättest mit dem Nordmann gesprochen, der vor kurzem hier war.";
};

func int DIA_Tandor_Nordmann_Condition ()
{	
	if Npc_KnowsInfo (other, DIA_Udar_Nordmann)
	{
			return TRUE;
	};
};

func void DIA_Tandor_Nordmann_Info ()
{
	AI_Output (other, self, "DIA_Tandor_Nordmann_15_00"); //Ich habe gehört, du hättest mit dem Nordmann gesprochen, der vor kurzem hier war.
	AI_Output (self, other, "DIA_Tandor_Nordmann_08_01"); //Das stimmt. Er wollte neue Waffen kaufen, da seine Schwerter schon ganz stumpf und schartig waren.
	AI_Output (other, self, "DIA_Tandor_Nordmann_15_02"); //Und?
	AI_Output (self, other, "DIA_Tandor_Nordmann_08_03"); //Ich habe ihm meine Auswahl gezeigt, doch er hat mich nur ausgelacht. Stattdessen hat er seine alten Waffen an der Schmiede neu geschärft.
	AI_Output (self, other, "DIA_Tandor_Nordmann_08_04"); //Der Mann schien sein Handwerk zu verstehen, er ist mit Sicherheit ein ziemlich guter Schmied.
	AI_Output (other, self, "DIA_Tandor_Nordmann_15_05"); //Und wo ist er jetzt?
	AI_Output (self, other, "DIA_Tandor_Nordmann_08_06"); //Er hatte einige Fragen zu den Orks, da habe ich ihn zu Oric geschickt.
	AI_Output (self, other, "DIA_Tandor_Nordmann_08_07"); //Der kennt sich als strategischer Offizier besser mit diesen Sachen aus als ich.

	B_GivePlayerXP	(100);

	B_LogEntry	(TOPIC_DGDH_NORDMANN, "Tandor hat ihn zu Oric weitergeschickt, ich sollte mit ihm über die Sache sprechen.");
};
///////////////////////////////////////////////////////////////////////
//	Info Spähtrupp
///////////////////////////////////////////////////////////////////////

...
//////////////             Sell_Dog1 
/////////////////////////////////////////////////////// 
instance Dia_PEPE_Sell_Dog1   (C_INFO) 
{ 
   npc     = BAU_912_Pepe; 
   nr          =998; 
   condition   =   Dia_PEPE_Sell_Dog1_condition; 
   information     = Dia_PEPE_Sell_Dog1_info; 
   important     =  FALSE; 
   permanent     = FALSE; 
   Description    = "Was ist das für ein Hund da?"; 
}; 
 
func int Dia_PEPE_Sell_Dog1_condition () 
{ 
	if (hero.level > 0)
	&& (!Mod_HM_An)
	{
...
func void Dia_PEPE_Sell_Dog1_info () 
{ 
   AI_Output (other,self,"Dia_PEPE_Sell_Dog1_00");  //Was ist das für ein Hund da? 
   AI_Output (self, other,"Dia_PEPE_Sell_Dog1_01");  //Der Hund? Das ist Draco. Hat mir ein Händler verkauft. Nichtsnütziges Vieh! Kräftig, aber zu dumm um ein richtiger Schäferhund zu sein. 
...
//////////////             Sell_Dog2 
/////////////////////////////////////////////////////// 
instance Dia_PEPE_Sell_Dog2   (C_INFO) 
{ 
   npc     = BAU_912_Pepe; 
   nr          =997; 
   condition   =   Dia_PEPE_Sell_Dog2_condition; 
   information     = Dia_PEPE_Sell_Dog2_info; 
   important     =  FALSE; 
   permanent     = FALSE; 
   Description    = "Kann ich ihn kaufen?"; 
}; 
 
func int Dia_PEPE_Sell_Dog2_condition () 
{ 
   IF (Npc_KnowsInfo(other,Dia_PEPE_Sell_Dog1)) 
   { 
   return TRUE; 
   }; 
}; 
 
func void Dia_PEPE_Sell_Dog2_info () 
{ 
   AI_Output (other,self,"Dia_PEPE_Sell_Dog2_00");  //Kann ich ihn kaufen? 
   AI_Output (self, other,"Dia_PEPE_Sell_Dog2_01");  //Ich hatte gehofft, dass du das fragst. Nur 250 Goldstücke! 
...
//////////////             Sell_Dog3 
/////////////////////////////////////////////////////// 
instance Dia_PEPE_Sell_Dog3   (C_INFO) 
{ 
   npc     = BAU_912_Pepe; 
   nr          =997; 
   condition   =   Dia_PEPE_Sell_Dog3_condition; 
   information     = Dia_PEPE_Sell_Dog3_info; 
   important     =  FALSE; 
   permanent     = FALSE; 
   Description    = "Abgemacht, hier sind 250 Goldstücke."; 
}; 
 
func int Dia_PEPE_Sell_Dog3_condition () 
{ 
   IF (Npc_KnowsInfo(other,Dia_PEPE_Sell_Dog2)) 
   && (Npc_HasItems (other, itmi_gold) >= 250)
   { 
   return TRUE; 
   }; 
}; 
 
func void Dia_PEPE_Sell_Dog3_info () 
{ 
	AI_Output (other,self,"Dia_PEPE_Sell_Dog3_00");  //Abgemacht, hier sind 250 Goldstücke. 
	AI_Output (self, other,"Dia_PEPE_Sell_Dog3_02");  //Gut! Hier ist noch ein Rufhorn. Falls du ihn mal verlieren solltest, kannst du ihn damit rufen.

	B_GiveInvItems (self, other, ItMi_Alarmhorn, 1);

	AI_Output (self, other,"Dia_PEPE_Sell_Dog3_01");  //Draco, das ist dein neues Herrchen, folge ihm! 
	...
	D_Exp = 250*((hero.level+1)/2)*(hero.level);
	D_EXP_NEXT = 250*((hero.level+2)/2)*(hero.level+1); 
	...
	dog_di.attribute[ATR_HITPOINTS_MAX] = D_HP;
	dog_di.attribute[ATR_HITPOINTS] = D_HP;

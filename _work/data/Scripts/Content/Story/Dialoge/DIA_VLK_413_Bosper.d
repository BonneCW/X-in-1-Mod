...
instance DIA_BOSPER_RESPAWN(C_Info)
{
	npc = VLK_413_Bosper;
	nr = 900;
	condition = dia_bosper_respawn_condition;
	information = dia_bosper_respawn_info;
	permanent = TRUE;
	description = "Hast du genug Felle?";
};


func int dia_bosper_respawn_condition()
{
	if (hero.level >= 9)
	{
		return TRUE;

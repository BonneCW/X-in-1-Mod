...
instance DIA_Addon_Cavalorn_GotOrnaFromHagen		(C_INFO)
{
	...
	description	 = 	"Ich habe das fehlende Ornament bekommen.";
};

func int DIA_Addon_Cavalorn_GotOrnaFromHagen_Condition ()
{
	if (PC_got_ORNAMENT == TRUE)
		{
			return TRUE;
		};
};
...
{
	AI_Output	(other, self, "DIA_Addon_Cavalorn_GotOrnaFromHagen_New_15_00"); //Ich habe das fehlende Ornament bekommen.
	AI_Output	(self, other, "DIA_Addon_Cavalorn_GotOrnaFromHagen_New_08_01"); //Siehst du? Hatte ich mir doch gedacht, dass die Paladine es hatten.
	B_GivePlayerXP (XP_Ambient);

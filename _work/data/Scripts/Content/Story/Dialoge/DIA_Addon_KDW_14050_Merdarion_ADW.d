...
{
	if ((Npc_KnowsInfo(other, DIA_Addon_Merdarion_FokusGeben) || Merdarion_GotFocusCount > 0) && !SC_ADW_ActivatedAllTelePortStones 
	    && TriggeredTeleporterADW <= Merdarion_GotFocusCount
	    && Npc_HasItems(other, ItMi_Focus) == 0)
	{
...
func int DIA_Addon_Merdarion_FirstFocus_Condition()
{
	...
	else if (Npc_KnowsInfo (other, DIA_Addon_Merdarion_FokusGeben) && (Npc_HasItems (other, ItMi_Focus) == 0))
	{
		Npc_PerceiveAll (self);
		if (Wld_DetectItem (self, ITEM_KAT_NONE))
		{
			if (Hlp_IsValidItem (item) && Hlp_IsItem (item, ItMi_Focus))
			{
...
func int DIA_Addon_Merdarion_ActivateTeleports_Condition()
{
	...
	else if (Npc_KnowsInfo (other, DIA_Addon_Merdarion_FirstFocus) && (TriggeredTeleporterADW <= Merdarion_GotFocusCount) && (TriggeredTeleporterADW < 5) && (Npc_HasItems (other, ItMi_Focus) == 0))
	{
		Npc_PerceiveAll (self);
		if (Wld_DetectItem (self, ITEM_KAT_NONE))
		{

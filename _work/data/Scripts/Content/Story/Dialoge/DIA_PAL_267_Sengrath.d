...
INSTANCE DIA_Sengrath_Nordmann (C_INFO)
{
	npc		= PAL_267_Sengrath;
	nr		= 2;
	condition	= DIA_Sengrath_Nordmann_Condition;
	information	= DIA_Sengrath_Nordmann_Info;
	permanent	= 0;
	IMPORTANT 	= 0;
	description	= "Du hast nicht zufällig einen Nordmarer in der Burg gesehen?";
};                       

FUNC INT DIA_Sengrath_Nordmann_Condition()
{
...
FUNC VOID DIA_Sengrath_Nordmann_Info()
{	
	AI_Output (other ,self,"DIA_Sengrath_Nordmann_15_00"); //Du hast nicht zufällig einen Nordmarer in der Burg gesehen?
	AI_Output (self ,other,"DIA_Sengrath_Nordmann_03_01"); //Doch, aber ich habe nicht mit ihm gesprochen.
	AI_Output (self ,other,"DIA_Sengrath_Nordmann_03_02"); //Er hat sich nur kurz mit Udar und Tandor unterhalten.
};
// ************************************************************
// 			  	Equipment 
// ************************************************************

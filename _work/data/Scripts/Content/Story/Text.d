...
CONST STRING MOBNAME_HThron			= "Heldenthron";	

CONST STRING MOBNAME_Portalg			= "Portal";	
...
CONST STRING MOBNAME_GRAVE_17	 = "Simbus Kahr 479 - 685";
...
CONST STRING MOBNAME_GRAVE_28	 = "Arthag Amashrog 730 - 756";
...
CONST STRING MOBNAME_MY1		= "Mythrilbrocken";
...
const string TXT_SPELLS[MAX_SPELL] =
{
	...
	"Warg beschwören",		// 92	SPL_Reserved_92
	"Rudel beschwören",		// 93	SPL_Reserved_93
	"Schattenläufer beschwören",		// 94	SPL_Reserved_94
	...
	"TXT_SPL_RESERVED_91",
	"Beschworene Kreaturen zurückschicken",
	"Teleport"
};
...
// ...
const string NAME_SPL_SummonSnapper			= "Snapper rufen";
...
// DM
const string NAME_SPL_Blutopfer = "Blutopfer";
const string NAME_SPL_Altern = "Altern";
const string NAME_SPL_Seelenraub = "Seelenraub";
const string NAME_SPL_Giftanschlag = "Giftanschlag";
const string NAME_SPL_Wahnsinn = "Wahnsinn";
const string NAME_SPL_ZORNADANOS = "Zorn Adanos";
const string NAME_SPL_SUMMONICEWOLF = "Eiswolf rufen";
const string NAME_SPL_SUMMONICEGOLEM = "Eisgolem erwecken";
const string NAME_SPL_fighterwhirl			= "Wirbelwind des Kämpfers";
const string NAME_SPL_redball		         	= "Energiestoss";
...
const string NAME_ADDON_BEARKDW = "Zusammen mit Wasserrobe      + ";

...
{
	if ((DragonTalk_Exit_Free == TRUE) && (((Npc_KnowsInfo(other, DIA_DragonTalk_Dark_1) + Npc_KnowsInfo(other, DIA_DragonTalk_Dark_2) + Npc_KnowsInfo(other, DIA_DragonTalk_Dark_3) + Npc_KnowsInfo(other, DIA_DragonTalk_Dark_4)) > MIS_KilledDragons) || !(SC_isDarkWarrior)))
		{
				return TRUE;
		};
};

...
INSTANCE OrcShaman_Aeron (Mst_Default_OrcShaman)
{
	// ------ visuals ------
	B_SetVisuals_OrcShaman();
	...
	CreateInvItems	(self, ItSc_TeleportOT_Fake, 1);
...
INSTANCE OrcShaman_Uriziel (Mst_Default_OrcShaman)
{
	// ------ visuals ------
	B_SetVisuals_OrcShaman();
	
	//-------- inventory --------
	EquipItem (self, ItMw_uriziel_u);
...
instance ORCSHAMAN_HOF1(Mst_Default_OrcShaman)
{
	name[0] = "Ork Schamane";
...
instance ORCSHAMAN_HOF2(Mst_Default_OrcShaman)
{
	name[0] = "Ork Schamane";
	flags = NPC_FLAG_IMMORTAL;
	B_SetVisuals_OrcShaman ();
...
instance ORCSHAMAN_HOF3(Mst_Default_OrcShaman)
{
	name[0] = "Ork Schamane";
	flags = NPC_FLAG_IMMORTAL;
	B_SetVisuals_OrcShaman ();

...
instance OLD_SKELETON(Mst_Skeleton_Lord)
{
	name[0] = " ";
	level = 120;
	guild = GIL_SKELETON;
	aivar[AIV_MM_REAL_ID] = 7007;
	...
	protection[PROT_FLY] = 10;
	protection[PROT_MAGIC] = 800;
	damagetype = DAM_EDGE;
	B_SetVisuals_Skeleton_Lord ();
	B_SetNpcVisual (self, MALE, "", 0, 0, itar_ancient_addon);
	CreateInvItems (self, ItMi_Nugget, 100);
};

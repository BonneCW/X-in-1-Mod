...
instance VLK_6004_Mythrilarbeiter (Npc_Default)
{
	// ------ NSC ------
	name 		= "Arbeiter"; 
	guild 		= GIL_VLK;
...
{	
	TA_Smalltalk			(08,00,23,00,"HL_ST_04");
    TA_Pick_Ore			(23,00,08,00,"HL_MM_04");
};

FUNC VOID Rtn_malert_6004 ()
{	
	TA_Smalltalk			(08,00,23,00,"HL_ST_04");
    TA_Smalltalk		(23,00,08,00,"HL_MM_04");
};

...
instance VLK_6003_Mythrilarbeiter (Npc_Default)
{
	// ------ NSC ------
	name 		= "Arbeiter"; 
	guild 		= GIL_VLK;
...
{	
	TA_Smalltalk		(08,00,23,00,"HL_ST_03");
  TA_Pick_Ore			(23,00,08,00,"HL_MM_03");
};

FUNC VOID Rtn_malert_6003 ()
{	
	TA_Smalltalk		(08,00,23,00,"HL_ST_03");
  TA_Smalltalk			(23,00,08,00,"HL_ST_03");
};

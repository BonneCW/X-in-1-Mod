...
const int GIL_KDW                                               = 4             ;       // LAPs-Hack: Wassermagier sind auch Magier
...
const int GIL_Bad						= 14	;	//LAPs-Hack: Die Bösen Magier
...
const int GIL_EMPTY_XX					= 63	;
const int GIL_EMPTY_YY					= 64	;
...
// ...
const int SPL_SummonSnapper			= 90; //Snapper rufen
const int SPL_VLight			= 91;
const int SPL_SummonWarg			= 92;
const int SPL_Summon3Warg			= 93;
const int SPL_SummonShadow			= 94;
const int SPL_Amok			= 95;
const int SPL_Ghostspell			= 96;
const int SPL_SummonDragon			= 97;
const int SPL_Earth			= 98;
const int SPL_Follow			= 99;

//Dunkle Magie
const int SPL_Blutopfer = 100;
const int SPL_Altern = 101;
const int SPL_Seelenraub = 102;
const int SPL_Giftanschlag = 103;
const int SPL_Wahnsinn = 104;
const int SPL_ZORNADANOS = 105;
const int SPL_SUMMONICEWOLF = 106;
const int SPL_SUMMONICEGOLEM = 107;
const int SPL_fighterWhirl           		= 108;
const int SPL_redball			= 109;
const int SPL_Summoner			= 110;
const int SPL_TeleportOT			= 111;
...
const int BELIEVABLE_HP_REGENERATION = 300;

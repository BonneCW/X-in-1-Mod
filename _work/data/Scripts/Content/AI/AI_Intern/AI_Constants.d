...
const int	ID_SUMMONED_SHADOWBEAST	= 65;
const int	ID_SUMMONED_WARG = 66;
const int ID_SUMMONED_ICEWOLF = 67;
const int ID_SUMMONED_ICEGOLEM = 68;
const int ID_SUMMONED_DRAGON = 69;
const int ID_YOUNG_GIANT_RAT = 69;
...
const int AIV_WasDead					= 89; //Dunkle Magie: Effekt des Amuletts
const int AIV_altern                                    = 90; //Dunkle Magie: schon gealtert
...
const int FAI_AGGRO					=47 ;
const int FAI_DEFENCE					=48 ;
...
const int	MOBSI_innosdolch					= 8;
const int	MOBSI_adanosdolch					= 9;
const int	MOBSI_beliardolch					= 10;
const int	MOBSI_hebelring					= 11;

...
func void B_AssessPlayer ()
{
	...
	if ((Hlp_GetInstanceID(self) == Hlp_GetInstanceID(Wache_01))
	|| (Hlp_GetInstanceID(self) == Hlp_GetInstanceID(Wache_02)))
	&& (Npc_IsInState(BDT_1083_Addon_Esteban, ZS_Talk))
	{
		return;
	};

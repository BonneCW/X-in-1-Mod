...
func int B_AssessEnterRoom()
{
	...
	&& (Npc_GetDistToWP(hero, "NW_CITY_MERCHANT_HUT_02_IN") < 500)
	{
		if ((Hlp_GetInstanceID(self) == Hlp_GetInstanceID(KDF_511_Daron))
		|| (Hlp_GetInstanceID(self) == Hlp_GetInstanceID(VLK_409_Zuris)))
		{
	...
	if ((portalguild > GIL_NONE) && (portalguild != GIL_PUBLIC) && Npc_IsInPlayersRoom (self))
	{

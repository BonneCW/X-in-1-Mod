...
func void Spell_Cast_TeleportOT ()
{
	...
	Wld_InsertNpc	(Zombie01,	"WP_DGDH_OT_08");
	Wld_InsertNpc	(Zombie02,	"WP_DGDH_OT_08");
	Wld_InsertNpc	(Zombie03,	"WP_DGDH_OT_08");
	Wld_InsertNpc	(Zombie04,	"WP_DGDH_OT_08");
	Wld_InsertNpc	(Zombie01,	"WP_DGDH_OT_08");
	Wld_InsertNpc	(Zombie02,	"WP_DGDH_OT_08");
	Wld_InsertNpc	(Zombie03,	"WP_DGDH_OT_08");
	Wld_InsertNpc	(Zombie04,	"WP_DGDH_OT_08");
	...
	Wld_InsertNpc	(OrcWarrior_Roam,	"WP_DGDH_OT_07");
	Wld_InsertNpc	(OrcWarrior_Roam,	"WP_DGDH_OT_07");
	Wld_InsertNpc	(OrcShaman_Sit,	"WP_DGDH_OT_07");
	Wld_InsertNpc	(OrcShaman_Sit,	"WP_DGDH_OT_07");
	Wld_InsertNpc	(OrcShaman_Uriziel,	"WP_DGDH_OT_07");

	B_LogEntry	(TOPIC_uriziel, "Der Teleportzauber brachte mich in eine alte Höhle. Irgendwie kommt sie mir bekannt vor ...");

	AI_Teleport		(self, "WP_DGDH_OT_01");
	AI_PlayAni		(self, "T_HEASHOOT_2_STAND" );
};

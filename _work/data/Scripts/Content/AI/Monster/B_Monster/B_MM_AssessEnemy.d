...
func void B_MM_AssessEnemy ()
{
  ...
  //Dunkle Magie Spieler trägt Orkamulett und anderer ist beeindruckt
  if (((self.guild > GIL_SEPERATOR_ORC) || (self.aivar[AIV_MM_REAL_ID] == ID_WARG)) && Orkamulett && (CurrentLevel == OLDWORLD_ZEN))
    {
      return;
    };

	if (Npc_IsInState(other, ZS_GolemDown))
	{
		return;
	};

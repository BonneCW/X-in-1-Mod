...
instance ITRU_TRANSWOLF(C_Item)
{
	name = "Verwandlung Wolf";
	mainflag = ITEM_KAT_RUNE;
	flags = 0;
	value = 10;
...
instance ITRU_TRANSDEMON(C_Item)
{
	name = "Verwandlung Dämon";
	mainflag = ITEM_KAT_RUNE;
	flags = 0;
	value = 10;
...
instance ITRU_TRANSSHADOW(C_Item)
{
	name = "Verwandlung Schattenläufer";
	mainflag = ITEM_KAT_RUNE;
	flags = 0;
	value = 10;
	visual = "ItRu_SumWolf.3DS";
...
instance ITRU_TRANSWARG(C_Item)
{
	name = "Verwandlung Warg";
	mainflag = ITEM_KAT_RUNE;
	flags = 0;
	value = 10;
	visual = "ItRu_SumWolf.3DS";
...
instance ITRU_ENERGY(C_Item)
{
	name = "Energie stehlen";
	mainflag = ITEM_KAT_RUNE;
	flags = 0;
	value = Value_Ru_SuckEnergy;
	visual = "ItRu_Beliar01.3DS";

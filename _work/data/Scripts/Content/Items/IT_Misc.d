...
INSTANCE ItMi_BeliarRing2 (C_Item)
{
  ...
  material = MAT_METAL;
  description = name;
  TEXT[1] = "Der Ring glüht vor Macht.";
  TEXT[5] = NAME_Value;
  COUNT[5] = value;
  INV_ZBIAS = INVCAM_ENTF_RING_STANDARD;
  INV_ROTZ = INVCAM_Z_RING_STANDARD;
...
{
  Print("Die Macht Beliars durchströmt deine Adern.");
...
INSTANCE ItMi_StahlBeliarStatue (C_Item)
{
	...
	description			= 	name;
	TEXT[1] = "Eine stählerne Beliar-Statuette.";
	TEXT[5]				= 	NAME_Value;	
	COUNT[5]			= 	value;
};
/******************************************************************************************/
...
INSTANCE ItMi_Feuerstein(C_Item)
{
  ...
  material = MAT_STONE;
  description = name;
  TEXT[4] = "Der Stein glüht von innen heraus.";
  TEXT[5] = NAME_Value;
...
INSTANCE ItMi_Wasserstein(C_Item)
{
  ...
  material = MAT_STONE;
  description = name;
  TEXT[4] = "Der Stein ist ständig feucht..";
  TEXT[5] = NAME_Value;
  COUNT[5] = Value_Aquamarine;
  INV_ZBIAS = INVCAM_ENTF_MISC_STANDARD;
};
...
INSTANCE ItMi_Wasserperle(C_Item)
{
  ...
  material = MAT_STONE;
  description = name;
  TEXT[4] = "Dieser Perle entströhmte eine magische Aura.";
  TEXT[5] = NAME_Value;
  COUNT[5] = Value_Aquamarine;
  INV_ZBIAS = INVCAM_ENTF_MISC_STANDARD;
};

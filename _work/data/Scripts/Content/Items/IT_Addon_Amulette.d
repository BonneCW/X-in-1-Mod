...
instance ITAM_VAMPIRSET1(C_Item)
{
	name = "Vampiramulett";
	mainflag = ITEM_KAT_MAGIC;
	flags = ITEM_AMULET;
	...
	visual_skin = 0;
	material = MAT_METAL;
	on_equip = schutzvorsonne1;
	on_unequip = schutzvorsonne1z;
	wear = WEAR_EFFECT;
	effect = "SPELLFX_WEAKGLIMMER_RED";
	description = "Teil des Vampirsets";
	text[2] = "Dies ist ein Teil";
	text[3] = "des legendären Vampirsets.";
	text[4] = "Es gibt noch 2 weitere Teile!";
	text[5] = NAME_Value;
	count[5] = value;
	inv_zbias = INVCAM_ENTF_AMULETTE_STANDARD;
};
...
instance ITRI_VAMPIRSET2(C_Item)
{
	name = "Vampirring";
	mainflag = ITEM_KAT_MAGIC;
	flags = ITEM_RING;
	...
	visual_skin = 0;
	material = MAT_METAL;
	on_equip = schutzvorsonne2;
	on_unequip = schutzvorsonne2z;
	wear = WEAR_EFFECT;
	effect = "SPELLFX_WEAKGLIMMER_RED";
	description = "Vampirring";
	text[2] = "Dies ist ein Teil";
	text[3] = "des legendären Vamirsets.";
	text[4] = "Es gibt noch 2 weitere Teile!";
	text[5] = NAME_Value;
	count[5] = value;
	inv_zbias = INVCAM_ENTF_RING_STANDARD;
...
instance ITRI_VAMPIRSET3(C_Item)
{
	name = "Vampirring";
	mainflag = ITEM_KAT_MAGIC;
	flags = ITEM_RING;
	...
	visual_skin = 0;
	material = MAT_METAL;
	on_equip = schutzvorsonne3;
	on_unequip = schutzvorsonne3z;
	wear = WEAR_EFFECT;
	effect = "SPELLFX_WEAKGLIMMER_RED";
	description = "Vampirring";
	text[2] = "Dies ist ein Teil";

...
const int Damage_Wolfsmesser 			= 22; 
...
const int Damage_Wolfsklinge 			= 15; 
...
const int Condition_Stab03			= 50;
const int Range_Stab03				= 120;
const int Value_Stab03				= 1950;
//Wassermagier	- NEUE INSTANZ //ADDON
const int Damage_Stab04				= 75; 
const int Condition_Stab04			= 75;
const int Range_Stab04				= 130;
const int Value_Stab04				= 3000;
//Wassermagier	- NEUE INSTANZ //ADDON
const int Damage_Stab05				= 100; 
const int Condition_Stab05			= 100;
const int Range_Stab05				= 130;
const int Value_Stab05				= 7050;
...
const int Damage_Schwert2			= 80; 
const int Condition_Schwert2		= 80;
...
const int Damage_Schwert4			= 85; //+6%
...
const int Damage_Special_2H_2		= 130; //+10%
...
const int Damage_ElBastardo			= 120; //+8%
	const int Damage_Betty		= 80;
const int CONDITION_BETTY = 80;
const int Condition_ElBastardo		= 120;
...
const int Damage_Meisterdegen		= 60; //+10%
...
const int Damage_Orkschlaechter	 	= 125; 
const int Condition_Orkschlaechter	= 120;
const int Range_Orkschlaechter		= 100;
const int Value_Orkschlaechter		= 1300;
//Schwerer Zweihänder
const int Damage_Zweihaender4 		= 125; 
const int Condition_Zweihaender4	= 125; 
...
const int Damage_Special_2H_3		= 180; //+10%
...
const int Damage_Berserkeraxt 		= 160; 
const int Condition_Berserkeraxt	= 160;
const int Range_Berserkeraxt		= 90; 
const int Value_Berserkeraxt		= 3000;
//Drachenschneide - NEUE INSTANZ
const int Damage_Drachenschneide 	= 155; 
const int Condition_Drachenschneide	= 155;
...
const int Damage_Special_2H_4		= 200; //+10%
...
const int CONDITION_BLESSED_1H_1_STR = 100;
const int CONDITION_BLESSED_1H_1_MANA = 60;
const int Range_Blessed_1H_1		= 100;
const int Value_Blessed_1H_1		= 2000; 
//Gesegnete Erzklinge - ItMw_1H_Blessed_02 
const int Damage_Blessed_1H_2		= 125; 
const int CONDITION_BLESSED_1H_2_STR = 100;
const int CONDITION_BLESSED_1H_2_MANA = 80;
...
const int CONDITION_BLESSED_1H_3_STR = 100;
const int CONDITION_BLESSED_1H_3_MANA = 100;
...
const int CONDITION_BLESSED_2H_1_STR = 120;
const int CONDITION_BLESSED_2H_1_MANA = 60;
const int Range_Blessed_2H_1		= 130;
const int Value_Blessed_2H_1		= 2000;
//Ordensschwert (2h) - ItMw_2H_Blessed_02
const int Damage_Blessed_2H_2		= 150; 
const int CONDITION_BLESSED_2H_2_STR = 120;
const int CONDITION_BLESSED_2H_2_MANA = 80;
const int Range_Blessed_2H_2		= 130;
const int Value_Blessed_2H_2		= 3000;
//Der heilige Vollstrecker (2h) - ItMw_2H_Blessed_03
const int Damage_Blessed_2H_3		= 170; 
const int CONDITION_BLESSED_2H_3_STR = 120;
const int CONDITION_BLESSED_2H_3_MANA = 100;

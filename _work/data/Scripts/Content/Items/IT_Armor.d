...
const int VALUE_ITAR_DARK = 18000;
...
const int VALUE_ITAR_KDW_L = 1500;
const int VALUE_ITAR_KDW_H		= 450;
const int VALUE_ITAR_Prisoner	= 10;
const int VALUE_ITAR_DarkPupil = 280;
const int VALUE_ITAR_SHADOW = 500;
const int VALUE_ITAR_TEMPLER = 2000;
...
// ****************************************************************************
INSTANCE ITAR_DarkPupil (C_Item)
{
	name 					=	"Robe der dunklen Schüler";
...
INSTANCE ORE_ARMOR_M(C_Item)
{
  ...
  value 					=	1000; // damit der Spieler keinen Profit draus schlägt
...
INSTANCE ITAR_Beliar (C_Item)
{
	name 					=	"Rüstung des Kriegers Beliars";
...
instance ITAR_VAMPIR(C_Item)
{
	...
	value = 10;
	wear = WEAR_TORSO;
	visual = "New_Armor_05.3ds";
	visual_change = "Armor_Dementorian.asc";
	visual_skin = 1;
	material = MAT_LEATHER;
	on_equip = schuz;
	on_unequip = schuzback;
	description = "Es scheint mich vor Sonnenlicht zu Schützen";
	text[1] = NAME_Prot_Edge;
	count[1] = protection[PROT_EDGE];
	text[2] = NAME_Prot_Point;
	count[2] = protection[PROT_POINT];

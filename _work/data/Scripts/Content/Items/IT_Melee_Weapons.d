...
instance ITMW_GORNS_AXT(C_Item)
{
	name = "Gorns Axt";
	mainflag = ITEM_KAT_NF;
	flags = ITEM_2HD_AXE;
...
{	
	...
	cond_atr[2] = ATR_STRENGTH;
	cond_value[1] = CONDITION_BLESSED_1H_1_MANA;
	cond_value[2] = CONDITION_BLESSED_1H_1_STR;
...
{	
	...
	cond_atr[1] = ATR_MANA_MAX;
	cond_atr[2] = ATR_STRENGTH;
	cond_value[1] = CONDITION_BLESSED_1H_2_MANA;
	cond_value[2] = CONDITION_BLESSED_1H_2_STR;
	visual 				=	"ItMw_030_1h_PAL_sword_bastard_RAW_01.3DS";
...
{	
	...
	cond_atr[1] = ATR_MANA_MAX;
	cond_atr[2] = ATR_STRENGTH;
	cond_value[1] = CONDITION_BLESSED_1H_3_MANA;
	cond_value[2] = CONDITION_BLESSED_1H_3_STR;
	visual 				=	"ItMw_030_1h_PAL_sword_bastard_RAW_01.3DS";
...
{	
	...
	cond_atr[1] = ATR_MANA_MAX;
	cond_atr[2] = ATR_STRENGTH;
	cond_value[1] = CONDITION_BLESSED_2H_1_MANA;
	cond_value[2] = CONDITION_BLESSED_2H_1_STR;
...
{	
	...
	on_equip = equip_itmw_2h_blessed_02;
	on_unequip = unequip_itmw_2h_blessed_02;
	cond_atr[1] = ATR_MANA_MAX;
	cond_atr[2] = ATR_STRENGTH;
	cond_value[1] = CONDITION_BLESSED_2H_2_MANA;
	cond_value[2] = CONDITION_BLESSED_2H_2_STR;
	visual 				=	"ItMw_040_2h_PAL_sword_heavy_RAW_01.3DS";
...
func void equip_itmw_2h_blessed_02()
{
...
func void unequip_itmw_2h_blessed_02()
{
	if (Npc_IsPlayer (self))
	{
		Npc_ChangeAttribute (self, ATR_MANA_MAX, -25);
...
{	
	...
	on_equip = equip_itmw_2h_blessed_03;
	on_unequip = unequip_itmw_2h_blessed_03;
	cond_atr[1] = ATR_MANA_MAX;
	cond_atr[2] = ATR_STRENGTH;
	cond_value[2] = CONDITION_BLESSED_2H_3_STR;
	cond_value[1] = CONDITION_BLESSED_2H_3_MANA;
	visual 				=	"ItMw_040_2h_PAL_sword_heavy_RAW_01.3DS";
...
func void equip_itmw_2h_blessed_03()
{
	if (Npc_IsPlayer (self))
	{
...
func void unequip_itmw_2h_blessed_03()
{
	if (Npc_IsPlayer (self))
	{
		Npc_ChangeAttribute (self, ATR_MANA_MAX, -50);
...
/********************************************************************************/
// **************************
// Waffen der Dunklen Krieger
// **************************
func void Dunkle_Waffe ()
{
  var C_Item Waffe;
  Waffe = Npc_GetEquippedMeleeWeapon (hero);
  if (!((hero.guild == GIL_Bad) && SC_IsDarkWarrior))
    {
      AI_UnequipWeapons(hero);
    };
  if ((Hlp_IsItem(Waffe, ItMw_1H_Goblinzahn) || Hlp_IsItem(Waffe, ItMw_2H_Goblinzahn)) && (Npc_GetTalentSkill(hero, Npc_Talent_Mage) < 1))
    {
      AI_UnequipWeapons(hero);
    };
  if ((Hlp_IsItem(Waffe, ItMw_1H_Wolfsfang) || Hlp_IsItem(Waffe, ItMw_2H_Wolfsfang)) && (Npc_GetTalentSkill(hero, Npc_Talent_Mage) < 2))
    {
      AI_UnequipWeapons(hero);
    };
  if ((Hlp_IsItem(Waffe, ItMw_1H_Knochenspalter) || Hlp_IsItem(Waffe, ItMw_2H_Knochenspalter)) && (Npc_GetTalentSkill(hero, Npc_Talent_Mage) < 3))
    {
      AI_UnequipWeapons(hero);
    };
  if ((Hlp_IsItem(Waffe, ItMw_1H_Golemfaust) || Hlp_IsItem(Waffe, ItMw_2H_Golemfaust)) && (Npc_GetTalentSkill(hero, Npc_Talent_Mage) < 4))
    {
      AI_UnequipWeapons(hero);
    };
  if ((Hlp_IsItem(Waffe, ItMw_1H_Daemonenschneide) || Hlp_IsItem(Waffe, ItMw_2H_Daemonenschneide)) && (Npc_GetTalentSkill(hero, Npc_Talent_Mage) < 5))
    {
      AI_UnequipWeapons(hero);
    };
  if ((Hlp_IsItem(Waffe, ItMw_1H_Lebensspender) || Hlp_IsItem(Waffe, ItMw_2H_Lebensspender)) && (Npc_GetTalentSkill(hero, Npc_Talent_Mage) < 2))
    {
      AI_UnequipWeapons(hero);
    };
  if ((Hlp_IsItem(Waffe, ItMw_1H_BeliarsRache) || Hlp_IsItem(Waffe, ItMw_2H_BeliarsRache)) && (Npc_GetTalentSkill(hero, Npc_Talent_Mage) < 3))
    {
      AI_UnequipWeapons(hero);
    };
  if ((Hlp_IsItem(Waffe, ItMw_1H_Bannklinge) || Hlp_IsItem(Waffe, ItMw_2H_Bannklinge)) && (Npc_GetTalentSkill(hero, Npc_Talent_Mage) < 4))
    {
      AI_UnequipWeapons(hero);
    };
    if ((Hlp_IsItem(Waffe, ItMw_1H_Feuerklinge) || Hlp_IsItem(Waffe, ItMw_2H_Feuerklinge)) && (Npc_GetTalentSkill(hero, Npc_Talent_Mage) < 3))
    {
      AI_UnequipWeapons(hero);
    };
    if ((Hlp_IsItem(Waffe, ItMw_1H_Wasserklinge) || Hlp_IsItem(Waffe, ItMw_2H_Wasserklinge)) && (Npc_GetTalentSkill(hero, Npc_Talent_Mage) < 3))
    {
      AI_UnequipWeapons(hero);
    };
    if ((Hlp_IsItem(Waffe, ItMw_1H_Sturmklinge) || Hlp_IsItem(Waffe, ItMw_2H_Sturmklinge)) && (Npc_GetTalentSkill(hero, Npc_Talent_Mage) < 3))
    {
      AI_UnequipWeapons(hero);
    };
    if ((Hlp_IsItem(Waffe, ItMw_1H_Schrumpfer) || Hlp_IsItem(Waffe, ItMw_2H_Schrumpfer)) && (Npc_GetTalentSkill(hero, Npc_Talent_Mage) < 5))
    {
      AI_UnequipWeapons(hero);
    };
};

instance ItMw_1H_Dunkelklinge (C_Item)
{
  name = "Dunkle Klinge";
  mainflag = ITEM_KAT_NF;
  flags = ITEM_SWD;
  ...
  TEXT[2] = NAME_Damage;
  COUNT[2] = damageTotal;
  TEXT[3] = NAME_OneHanded;
  TEXT[4] = "Die typische Waffe eines Dunklen Kriegers.";
  on_Equip = Dunkle_Waffe;
};

instance ItMw_2H_Dunkelklinge (C_Item)
{
  name = "Dunkles Breitschwert";
  mainflag = ITEM_KAT_NF;
  flags = ITEM_2HD_SWD;
  material = MAT_METAL;
  value = 2000;
...
instance ItMw_1H_Goblinzahn (C_Item)
{
  name = "Goblinzahn";
  mainflag = ITEM_KAT_NF;
  flags = ITEM_SWD;
...
instance ItMw_2H_Goblinzahn (C_Item)
{
  name = "Goblinfang";
  mainflag = ITEM_KAT_NF;
  flags = ITEM_2HD_SWD;
...
instance ItMw_1H_Wolfsfang (C_Item)
{
  name = "Wolfsfang";
  mainflag = ITEM_KAT_NF;
  flags = ITEM_SWD;
...
instance ItMw_2H_Wolfsfang (C_Item)
{
  name = "Wolfbiss";
  mainflag = ITEM_KAT_NF;
  flags = ITEM_2HD_SWD;
...
instance ItMw_1H_Knochenspalter (C_Item)
{
  name = "Knochenspalter";
  mainflag = ITEM_KAT_NF;
  flags = ITEM_SWD;
...
instance ItMw_2H_Knochenspalter (C_Item)
{
  name = "Knochenspalter";
  mainflag = ITEM_KAT_NF;
  flags = ITEM_2HD_SWD;
...
instance ItMw_1H_Golemfaust (C_Item)
{
  name = "Golemfaust";
  mainflag = ITEM_KAT_NF;
  flags = ITEM_SWD;
...
instance ItMw_2H_Golemfaust (C_Item)
{
  name = "Golemfaust";
  mainflag = ITEM_KAT_NF;
  flags = ITEM_2HD_SWD;
...
instance ItMw_1H_Daemonenschneide (C_Item) 
{	
  name = "Dämonenschneide";
  mainflag = ITEM_KAT_NF;
  flags = ITEM_SWD|ITEM_MISSION;	
  material = MAT_METAL;
  value	= 10000;
  ...
  damage[DAM_INDEX_MAGIC] = 200;
  range	= 150;		
  visual = "ItMw_1H_Demon.3DS";
  description = name;
  TEXT[0] = "Dies ist eine der legendären Dämonenschneiden.";
  TEXT[1] = "Sie ist magisch geladen";
...
instance ItMw_2H_Daemonenschneide (C_Item) 
{	
  name = "Dämonenschneide";
  mainflag = ITEM_KAT_NF;
  ...
  value	= 10000;
  damageType = DAM_FIRE|DAM_MAGIC;
  damage[DAM_INDEX_FIRE] = 220;
  damage[DAM_INDEX_MAGIC] = 210;
  range	= 180;		
...
instance ItMw_1H_Lebensspender (C_Item)
{
  name = "Lebensspender";
  mainflag = ITEM_KAT_NF;
  flags = ITEM_SWD;
  ...
  TEXT[3] = "Eine magische Waffe.";
  TEXT[4] = "Diese Waffe entzieht dem Gegner Lebenskraft.";
  TEXT[5] = "2.Kreis";
  on_Equip = Dunkle_Waffe;
}; 

instance ItMw_2H_Lebensspender (C_Item)
{
  name = "Lebensspender";
  mainflag = ITEM_KAT_NF;
  flags = ITEM_2HD_SWD;
...
instance ItMw_1H_BeliarsRache (C_Item)
{
  name = "Beliars Rache";
  mainflag = ITEM_KAT_NF;
  flags = ITEM_SWD;
  ...
  TEXT[2] = Name_OneHanded;
  TEXT[3] = "Eine magische Waffe.";
  TEXT[4] = "Beliars Antwort auf Verräter";
  TEXT[5] = "3.Kreis";
  on_Equip = Dunkle_Waffe;
}; 

instance ItMw_2H_BeliarsRache (C_Item)
{
  name = "Beliars Rache";
  mainflag = ITEM_KAT_NF;
  flags = ITEM_2HD_SWD;
...
instance ItMw_1H_Bannklinge (C_Item)
{
  name = "Feind der Toten";
  mainflag = ITEM_KAT_NF;
  flags = ITEM_SWD;
  material = MAT_METAL;
  ...
  TEXT[2] = Name_OneHanded;
  TEXT[3] = "Eine magische Waffe.";
  TEXT[4] = "Sendet Untote zurück in Beliars Reich";
  TEXT[5] = "4.Kreis";
  on_Equip = Dunkle_Waffe;
}; 

instance ItMw_2H_Bannklinge (C_Item)
{
  name = "Fluch der Toten";
  mainflag = ITEM_KAT_NF;
  flags = ITEM_2HD_SWD;
  material = MAT_METAL;
  value = Value_Ru_HarmUndead;
...
instance ItMw_1H_Feuerklinge (C_Item)
{
  name = "Flammenzunge";
  mainflag = ITEM_KAT_NF;
  flags = ITEM_SWD;
  ...
  TEXT[2] = Name_OneHanded;
  TEXT[3] = "Eine magische Waffe.";
  TEXT[4] = "Richtet Feuerschaden an";
  TEXT[5] = "3.Kreis";
  on_Equip = Dunkle_Waffe;
}; 

instance ItMw_2H_Feuerklinge (C_Item)
{
  name = "Flammenschwert";
  mainflag = ITEM_KAT_NF;
  flags = ITEM_2HD_SWD;
...
instance ItMw_1H_Wasserklinge (C_Item)
{
  name = "Adanos Wort";
  mainflag = ITEM_KAT_NF;
  flags = ITEM_SWD;
  ...
  TEXT[2] = Name_OneHanded;
  TEXT[3] = "Eine magische Waffe.";
  TEXT[4] = "Richtet Wasserschaden an";
  TEXT[5] = "3.Kreis";
  on_Equip = Dunkle_Waffe;
}; 

instance ItMw_2H_Wasserklinge (C_Item)
{
  name = "Adanos Zorn";
  mainflag = ITEM_KAT_NF;
  flags = ITEM_2HD_SWD;
...
instance ItMw_1H_Sturmklinge (C_Item)
{
  name = "Macht des Windes";
  mainflag = ITEM_KAT_NF;
  flags = ITEM_SWD;
  material = MAT_METAL;
  value = 1;
  ...
  TEXT[2] = Name_OneHanded;
  TEXT[3] = "Eine magische Waffe.";
  TEXT[4] = "Richtet Windschaden an";
  TEXT[5] = "3.Kreis";
  on_Equip = Dunkle_Waffe;
}; 

instance ItMw_2H_Sturmklinge (C_Item)
{
  name = "Macht des Sturms";
  mainflag = ITEM_KAT_NF;
  flags = ITEM_2HD_SWD;
  material = MAT_METAL;
  value = 1;
  ...
  TEXT[2] = Name_TwoHanded;
  TEXT[3] = "Eine magische Waffe.";
  TEXT[4] = "Richtet Sturmschaden an";
  TEXT[5] = "3.Kreis";
  on_Equip = Dunkle_Waffe;
};

instance ItMw_1H_Schrumpfer (C_Item)
{
  name = "Schlachtenwender";
  mainflag = ITEM_KAT_NF;
  flags = ITEM_SWD;
  material = MAT_METAL;
  value = 1;
  ...
  TEXT[2] = Name_OneHanded;
  TEXT[3] = "Eine magische Waffe.";
  TEXT[4] = "Lässt den Gegner schrumpfen.";
  TEXT[5] = "5.Kreis";
  on_Equip = Dunkle_Waffe;
}; 

instance ItMw_2H_Schrumpfer (C_Item)
{
  name = "Schlachtenwender";
  mainflag = ITEM_KAT_NF;
  flags = ITEM_2HD_SWD;
...
instance ItMw_2H_Feuerkriegerklinge (C_Item)
{
  ...
  COUNT[1] = damageTotal;
  TEXT[2] = Name_TwoHanded;
  TEXT[3] = "Diese Waffe gehört einem Feuerkrieger.";
  TEXT[4] = "Die Macht der Götter wohnt in ihr.";
  TEXT[5] = "Nur Feuerkrieger dürfen diese Waffe anlegen.";
  on_Equip = Feuerkriegerklinge;
}; 

func void Feuerkriegerklinge ()
{

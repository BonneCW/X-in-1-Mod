...
const int VALUE_RU_SUMICEWOLF = 1500;
const int VALUE_RU_SUMICEGOL = 2000;
const int VALUE_RU_ZORNADANOS = 3000;
// Kreis 2	
...
const   int     Value_Ru_SumSnapper                     =       1000;
...
//DM - Runen
const int Value_Ru_Blutopfer = 500;
const int Value_Ru_Altern = 1000;
const int Value_Ru_Seelenraub = 1500;
const int Value_Ru_Giftanschlag = 2000;
...
instance ITRU_EARTHQUKE(C_Item)
{
	name = "Erdbeben";
	mainflag = ITEM_KAT_RUNE;
	flags = 0;
...
instance ITRU_SUMICEWOLF(C_Item)
{
	name = NAME_Rune;
	mainflag = ITEM_KAT_RUNE;
	flags = 0;
	value = VALUE_RU_SUMICEWOLF;
	...
	count[0] = mag_circle;
	text[1] = NAME_Manakosten;
	count[1] = SPL_COST_SUMMONICEWOLF;
	text[5] = NAME_Value;
	count[5] = value;
};
...
instance ITRU_ZORNADANOS(C_Item)
{
	name = NAME_Rune;
	mainflag = ITEM_KAT_RUNE;
	flags = 0;
	value = VALUE_RU_ZORNADANOS;
	visual = "ItRu_PalDestroyEvil.3DS";
	material = MAT_STONE;
	spell = SPL_ZORNADANOS;
	mag_circle = 6;
	wear = WEAR_EFFECT;
	effect = "SPELLFX_WEAKGLIMMER";
	description = NAME_SPL_ZORNADANOS;
	text[0] = NAME_Mag_Circle;
	count[0] = mag_circle;
	text[1] = NAME_Manakosten;
	count[1] = SPL_COST_ZORNADANOS;
	text[2] = NAME_Dam_Magic;
	count[2] = SPL_DAMAGE_ZORNADANOS;
	text[5] = NAME_Value;
	count[5] = value;
};
/*******************************************************************************************/
...
INSTANCE ItRu_Summoner (C_Item)
{
	...
	description			=	"Beschworene Kreaturen zurückschicken";
	
	TEXT	[0]			=	"Schickt alle eignen beschworenen Kreaturen auf der Karte zurück,";			
	
	TEXT	[1]			=	"sodass vor Ort neue beschworen werden können";		
	
	TEXT	[3]			=	NAME_Manakosten;		
	COUNT	[3]			=	SPL_COST_LIGHT;
...
/*******************************************************************************************/	
INSTANCE ItRu_SumDemon2 (C_Item)
{
	name 				=	NAME_Rune;
...
INSTANCE ItRu_Giftanschlag (C_Item)
{
	name 				=	NAME_Rune;
	...
	spell				= 	SPL_Giftanschlag;

	wear				= 	WEAR_EFFECT;
	effect				=	"SPELLFX_WEAKGLIMMER";
	
	description			= 	NAME_SPL_Giftanschlag;
	...
	TEXT	[1]			=	NAME_MinManakosten;							
	COUNT	[1]			=	STEP_Giftanschlag;
	
	TEXT	[2]			=	NAME_ManakostenMax;							
	COUNT	[2]			=	SPL_COST_Giftanschlag;
	
	TEXT	[3]			=	NAME_Addon_Damage_Min;
	count 	[3]			=   SPL_Damage_Giftanschlag;
	
	TEXT	[4]			=	NAME_Damage_Max;
	COUNT	[4]			=	(SPL_Damage_Giftanschlag*4);
...
instance ITRU_GHOST(C_Item)
{
	...
	wear = WEAR_EFFECT;
	effect = "SPELLFX_WEAKGLIMMER";
	description = "Spaltung";
	text[0] = "Spaltet Körper und Geist";
	text[1] = NAME_Manakosten;
	count[1] = 30;
	text[2] = NAME_Dam_Magic;
	count[2] = 0;
...
instance ITRU_FOLLOW(C_Item)
{
	...
	text[1] = NAME_MinManakosten;
	count[1] = 20;
	text[2] = "Lässt Menschen für kurze Zeit folgsam werden";
	text[5] = NAME_Value;
	count[5] = value;
};

instance ITRU_SUMWARG(C_Item)
{
	name = "Warg beschwören";
	mainflag = ITEM_KAT_RUNE;
	flags = 0;
	value = Value_Ru_SumWolf;
	visual = "ItRu_SumWolf.3DS";
	material = MAT_STONE;
	spell = SPL_SUMMONWARG;
	mag_circle = 0;
	wear = WEAR_EFFECT;
	effect = "SPELLFX_WEAKGLIMMER";
	description = "Warg beschwören";
	text[0] = NAME_Mag_Circle;
	count[0] = mag_circle;
	text[1] = NAME_Manakosten;
	count[1] = 20;
...
instance ITRU_SUM3WARG(C_Item)
{
	name = "Rudel beschwören";
	mainflag = ITEM_KAT_RUNE;
	flags = 0;
	value = Value_Ru_SumWolf;
	visual = "ItRu_SumWolf.3DS";
	material = MAT_STONE;
	spell = SPL_SUMMON3WARG;
	mag_circle = 0;
	wear = WEAR_EFFECT;
	effect = "SPELLFX_WEAKGLIMMER_red";
	description = "Rudel beschwören";
	text[0] = NAME_Mag_Circle;
	count[0] = mag_circle;
	text[1] = NAME_Manakosten;
	count[1] = 55;
...
instance ITRU_SUMSHADOW(C_Item)
{
	name = "Schattenläufer beschwören";
	mainflag = ITEM_KAT_RUNE;
	flags = 0;
	value = 30;
	visual = "ItRu_SumWolf.3DS";
	material = MAT_STONE;
	spell = SPL_SUMMONSHADOW;
	mag_circle = 0;
	wear = WEAR_EFFECT;
	effect = "SPELLFX_WEAKGLIMMER";
	description = "Schattenläufer beschwören";
	text[0] = NAME_Mag_Circle;
	count[0] = mag_circle;
	text[1] = NAME_Manakosten;
	count[1] = 55;
...
instance ITRU_SOUL(C_Item)
{
	...
	wear = WEAR_EFFECT;
	effect = "SPELLFX_WEAKGLIMMER_red";
	description = "Soulcube";
	text[0] = "Mächtiger Zauber";
	text[1] = NAME_Manakosten;
	count[1] = SPL_COST_SOUL;
	text[2] = NAME_Dam_Magic;
	count[2] = SPL_DAMAGE_SOUL;
	text[3] = "Sechs Seelen Verstorbener reichen aus, um die Rune aufzuladen";
	text[5] = NAME_Value;
	count[5] = value;
};
...
func void soulsta()
{
	SOULCUBE_STATE = FALSE;
	KILLACCOUNT = 0;
};

instance ITRU_GHOSTSPELL(C_Item)
{
	name = NAME_Rune;
	mainflag = ITEM_KAT_RUNE;
	flags = 0;

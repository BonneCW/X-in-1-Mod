...
const int VALUE_ITBE_ADDON_KDW_01 = 250;
...
instance ITBE_ADDON_KDW_01(C_Item)
{
	name = NAME_Addon_BeltMage;
	mainflag = ITEM_KAT_MAGIC;
	flags = ITEM_BELT | ITEM_MULTI;
	value = value_itbe_addon_kdw_01;
	visual = "ItMi_Belt_02.3ds";
	visual_skin = 0;
	material = MAT_METAL;
	on_equip = equip_itbe_addon_kdw_01;
	on_unequip = unequip_itbe_addon_kdw_01;
	description = "Schärpe des Wassers";
	text[1] = NAME_Prot_Edge;
	count[1] = Belt_Prot_01;
	text[2] = NAME_Prot_Point;
	count[2] = Belt_Prot_01;
	text[3] = NAME_ADDON_BEARKDW;
	count[3] = BA_Bonus01;
	text[5] = NAME_Value;
	count[5] = value;
	inv_zbias = INVCAM_ENTF_AMULETTE_STANDARD;
...
func void equip_itbe_addon_kdw_01()
{
	KDW01_EQUIPPED = TRUE;
	self.protection[PROT_EDGE] += Belt_Prot_01;
	self.protection[PROT_BLUNT] += Belt_Prot_01;
...
func void unequip_itbe_addon_kdw_01()
{
	KDW01_EQUIPPED = FALSE;
	self.protection[PROT_EDGE] -= Belt_Prot_01;
	self.protection[PROT_BLUNT] -= Belt_Prot_01;
	self.protection[PROT_POINT] -= Belt_Prot_01;
	if (KDWARMOR_EQUIPPED == TRUE)

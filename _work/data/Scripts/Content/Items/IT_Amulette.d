...
/******************************************************************************************/
INSTANCE  ItAm_Seelen (C_Item)
{
  name = "Die Macht der Vereinigung";
  mainflag = ITEM_KAT_MAGIC;
  flags = ITEM_AMULET;
  value	= 1000;
  ...
  effect = "SPELLFX_ITEMGLIMMER"; 
  description = name;
  TEXT[2] = "Entstanden aus der vereingigten Macht aller drei Götter";
  TEXT[3] = "Wirkung unbekannt";
  TEXT[5] = NAME_Value;
  COUNT[5] = value;
  INV_ZBIAS = INVCAM_ENTF_AMULETTE_STANDARD;
  on_equip = Equip_ItAm_Seelen;
  on_unequip = UnEquip_ItAm_Seelen;
};

func void Equip_ItAm_Seelen ()
{
...
func void UnEquip_ItAm_Seelen ()
{
  Seelen = false;
};

INSTANCE ItAm_Ork (C_Item)
{
  name = "Botenamulett der Dunkelmagier";
  mainflag = ITEM_KAT_MAGIC;
  flags = ITEM_AMULET;
  value = 0;
  visual = "ItAm_Prot_Fire_01.3ds";
  ...
  effect = "SPELLFX_ITEMGLIMMER";
  description = name;
  TEXT[2] = "Dieses Amulett kennzeichnet Boten der Dunkelmagier";
  TEXT[3] = "Vorsicht: Die Orks könnten es nicht mehr anerkennen!";
  INV_ZBIAS = INVCAM_ENTF_AMULETTE_STANDARD;
  on_equip = Equip_ItAm_Ork;
  on_unequip = UnEquip_ItAm_Ork;
};

func void Equip_ItAm_Ork ()
{
  Orkamulett = true;
};

func void UnEquip_ItAm_Ork ()
{
  Orkamulett = false;
};


instance ITAM_BELIAR(C_Item)
{
	name = "Dunkles Amulett";
	mainflag = ITEM_KAT_MAGIC;
	flags = ITEM_AMULET;
	value = Value_Am_Strg;
	visual = "ItAm_Strg_01.3ds";
	visual_skin = 0;
	material = MAT_METAL;
	on_equip = equip_itam_beliar;
	on_unequip = unequip_itam_beliar;
	wear = WEAR_EFFECT;
	effect = "SPELLFX_fireswordblack";
	description = "Dunkles Amulett";
	text[5] = NAME_Value;
	count[5] = value;
	inv_zbias = INVCAM_ENTF_AMULETTE_STANDARD;
};
...
func void equip_itam_beliar()
{
	...
	Npc_ChangeAttribute (self, ATR_HITPOINTS_MAX, 90);
};

func void unequip_itam_beliar()
{
	Npc_ChangeAttribute (self, ATR_STRENGTH, -30);
	Npc_ChangeAttribute (self, ATR_MANA_MAX, -30);
	Npc_ChangeAttribute (self, ATR_DEXTERITY, -30);

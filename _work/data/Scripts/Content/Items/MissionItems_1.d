...
instance ITWR_TIMESWORD_1(C_Item)
{
	name = "Zettel";
	mainflag = ITEM_KAT_DOCS;
	flags = ITEM_MISSION;
	...
	visual = "ItWr_Scroll_01.3DS";
	material = MAT_LEATHER;
	on_state[0] = use_timesword_1;
	scemeName = "MAP";
	description = "Zerrissener Zettel";
};


func void use_timesword_1()
{
	var int nDocID;
	nDocID = Doc_Create ();
	Doc_SetPages (nDocID, 1);
	...
	Doc_PrintLine (nDocID, 0, "");
	Doc_SetFont (nDocID, 0, FONT_Book);
	Doc_PrintLine (nDocID, 0, " Um das mächtigste aller von Menschenhand ");
	Doc_PrintLine (nDocID, 0, " geschaffenen Schwerter, das Zeitschwert,");
	Doc_PrintLine (nDocID, 0, " herzustellen, muss man ein kundiger Schmied");
	Doc_PrintLine (nDocID, 0, " sein.");
	Doc_PrintLine (nDocID, 0, " Zuerst stellt man einen Überzug an einem ");
	Doc_PrintLine (nDocID, 0, " Alchemietisch her:");
	Doc_PrintLine (nDocID, 0, " Man vermischt 1 Brocken schwarzes Erz");
	Doc_PrintLine (nDocID, 0, " mit einem kleinen Bröckchen Runenstein,");
	Doc_PrintLine (nDocID, 0, " eine Drachenwuzel und einen Kronstöckel");
	Doc_PrintLine (nDocID, 0, " Und erhitzt das Ganze.");
	Doc_PrintLine (nDocID, 0, " Dann geht man zur Schmiede und");
	Doc_PrintLine (nDocID, 0, "...................................");
	Doc_SetMargins (nDocID, -1, 200, 50, 50, 50, 1);
	Doc_Show (nDocID);
	SC_CAN_TIMESWORDUEBERZUG = TRUE;
};


instance ITWR_RITUAL_1(C_Item)
{
	name = "Zettel";
	mainflag = ITEM_KAT_DOCS;
	flags = ITEM_MISSION;
	...
	visual = "ItWr_Scroll_01.3DS";
	material = MAT_LEATHER;
	on_state[0] = use_ritual_1;
	scemeName = "MAP";
	description = "Zerrissener Zettel";
};


func void use_ritual_1()
{
	var int nDocID;
	nDocID = Doc_Create ();
	Doc_SetPages (nDocID, 1);
	Doc_SetPage (nDocID, 0, "letters_skizze_ritual.TGA", 0);
	Doc_SetFont (nDocID, -1, FONT_Book);
	Doc_SetMargins (nDocID, -1, 50, 50, 50, 50, 1);
	Doc_PrintLine (nDocID, 0, "");
	Doc_PrintLine (nDocID, 0, "");
...
instance ITWR_TIMESWORD_2(C_Item)
{
	name = "Zettel";
	mainflag = ITEM_KAT_DOCS;
	flags = ITEM_MISSION;
	...
	visual = "ItWr_Scroll_01.3DS";
	material = MAT_LEATHER;
	on_state[0] = use_timesword_2;
	scemeName = "MAP";
	description = "Zerrissener Zettel";
};


func void use_timesword_2()
{
	var int nDocID;
	nDocID = Doc_Create ();
	Doc_SetPages (nDocID, 1);
	...
	Doc_SetFont (nDocID, 0, FONT_Book);
	Doc_PrintLine (nDocID, 0, " ..............................");
	Doc_PrintLine (nDocID, 0, " verarbeitet 5 schwarze Erzbrocken ");
	Doc_PrintLine (nDocID, 0, " zu einem Stück Stahl. Nun fängt man ");
	Doc_PrintLine (nDocID, 0, " an es zu bearbeiten, entweder als");
	Doc_PrintLine (nDocID, 0, " Einhand oder Zweihandwaffe. ");
	Doc_PrintLine (nDocID, 0, " Wenn das Schwert fertig geschmiedet ist");
	Doc_PrintLine (nDocID, 0, " überzieht man es mit dem Überzug");
	Doc_PrintLine (nDocID, 0, " und erhält damit das mächtige");
	Doc_PrintLine (nDocID, 0, " Zeitschwert.");
	Doc_PrintLine (nDocID, 0, "");
	Doc_PrintLine (nDocID, 0, "");
	Doc_PrintLine (nDocID, 0, "");
	Doc_SetMargins (nDocID, -1, 200, 50, 50, 50, 1);
	Doc_Show (nDocID);
	SC_CAN_TIMESWORDSTAHL = TRUE;
};


instance ITWR_MEISTERBRIEF(C_Item)
{
	name = "Brief";
	mainflag = ITEM_KAT_DOCS;
	flags = ITEM_MISSION;
	...
	visual = "ItWr_Scroll_01.3DS";
	material = MAT_LEATHER;
	on_state[0] = use_meisterbrief;
	scemeName = "MAP";
	description = "Seltsamer Brief";
};


func void use_meisterbrief()
{
	var int nDocID;
	nDocID = Doc_Create ();
	Doc_SetPages (nDocID, 1);
	...
	Doc_SetFont (nDocID, -1, FONT_Book);
	Doc_SetMargins (nDocID, -1, 50, 50, 50, 50, 1);
	Doc_PrintLine (nDocID, 0, "Hallo mein neuer Diener,");
	Doc_PrintLine (nDocID, 0, "Wie du vielleicht schon bemerkt hast, bist");
	Doc_PrintLine (nDocID, 0, "du nicht mehr du selbst.");
	Doc_PrintLine (nDocID, 0, "Du bist jetzt einer von uns, ein Vampir");
	Doc_PrintLine (nDocID, 0, "Ich habe dich zu dem gemacht, was du jetzt bist,");
	Doc_PrintLine (nDocID, 0, "um die Menschheit und damit auch uns zu retten.");
	Doc_PrintLine (nDocID, 0, "Du bist jetzt viel stärker und mächtiger, aber du");
	Doc_PrintLine (nDocID, 0, "musst dich auch an bestimmte ");
	Doc_PrintLine (nDocID, 0, "Verhaltensweisen halten: ");
	Doc_PrintLine (nDocID, 0, "1. Halte dich nie bei Sonnenschein draußen auf!");
	Doc_PrintLine (nDocID, 0, "   Mein Umhang kann dich vor der Sonne schützen.");
	Doc_PrintLine (nDocID, 0, "2. Um zu überleben musst du Menschenblut trinken.");
	Doc_PrintLine (nDocID, 0, "   Dieses findest du bei deinen Opfern");
	Doc_PrintLine (nDocID, 0, "   Tote bringen mehr Blut, als Bewusstlose.");
	Doc_PrintLine (nDocID, 0, "3. Sprich mit niemandem über dein Geheimnis!");
	Doc_PrintLine (nDocID, 0, "");
	Doc_PrintLine (nDocID, 0, "Das Schicksal der Menschen und ");
	Doc_PrintLine (nDocID, 0, "Vampire liegt in deinen Händen!");
	Doc_PrintLine (nDocID, 0, "");
	Doc_PrintLine (nDocID, 0, " Dein Meister");
	Doc_SetMargins (nDocID, -1, 200, 50, 50, 50, 1);
	Doc_Show (nDocID);
};


instance ITWR_BLADESBRIEF(C_Item)
{
	name = "Brief";
	mainflag = ITEM_KAT_DOCS;
	flags = ITEM_MISSION;
	...
	visual = "ItWr_Scroll_01.3DS";
	material = MAT_LEATHER;
	on_state[0] = use_blades;
	scemeName = "MAP";
	description = "Seltsamer Brief";
};


func void use_blades()
{
	var int nDocID;
	nDocID = Doc_Create ();
	Doc_SetPages (nDocID, 1);
	...
	Doc_PrintLine (nDocID, 0, "");
	Doc_PrintLine (nDocID, 0, "");
	Doc_PrintLine (nDocID, 0, "Endlich habe ich euch gefunden!");
	Doc_PrintLine (nDocID, 0, "Ihr Vampire, seid der Abschaum dieser Welt!");
	Doc_PrintLine (nDocID, 0, "Doch ich habe auch von deinen Taten gehört.");
	Doc_PrintLine (nDocID, 0, "Deshalb biete ich dir ein faires Todesduell an");
	Doc_PrintLine (nDocID, 0, "Triff mich bei der großen Trollhöhle im Norden.");
	Doc_PrintLine (nDocID, 0, "");
	Doc_PrintLine (nDocID, 0, "");
	Doc_PrintLine (nDocID, 0, "Blade ");
	Doc_SetMargins (nDocID, -1, 200, 50, 50, 50, 1);
	Doc_Show (nDocID);
};


instance ITWR_SECRET(C_Item)
{
	name = "Zettel";
	mainflag = ITEM_KAT_DOCS;
	flags = ITEM_MISSION;
	...
	visual = "ItWr_Scroll_01.3DS";
	material = MAT_LEATHER;
	on_state[0] = use_secretbrief;
	scemeName = "MAP";
	description = "Seltsamer Zettel";
};


func void use_secretbrief()
{
	var int nDocID;
	nDocID = Doc_Create ();
	Doc_SetPages (nDocID, 1);
	...
	Doc_PrintLine (nDocID, 0, "");
	Doc_PrintLine (nDocID, 0, "");
	Doc_PrintLine (nDocID, 0, "Mnogo Magi hota Ralok Daiga estat,");
	Doc_PrintLine (nDocID, 0, "sed ne omni kalut. Tolki antu Mag,");
	Doc_PrintLine (nDocID, 0, "re Foral Jaratas neskit, pet i estat. ");
	Doc_PrintLine (nDocID, 0, "I Mag invit sweta Garsan: E Garsan do");
	Doc_PrintLine (nDocID, 0, "Reko et sweta werata Innos vet.");
	Doc_PrintLine (nDocID, 0, "A plat tra i lotai Werati et lombit so Zas,");
	Doc_PrintLine (nDocID, 0, "do Neska Innos silnesi git.");
	Doc_PrintLine (nDocID, 0, "Ga i Zas urit a Foral et estat Ralok.");
	Doc_PrintLine (nDocID, 0, "");
	Doc_PrintLine (nDocID, 0, "Lekatot ");
	Doc_SetMargins (nDocID, -1, 200, 50, 50, 50, 1);
	Doc_Show (nDocID);
	Log_CreateTopic (SECRETS, LOG_MISSION);
	Log_SetTopicStatus (SECRETS, LOG_Running);
	B_LogEntry (SECRETS, "An einem Strand habe ich eine Flaschenpost gefunden. Die Nachricht ist in einer seltsamen Sprache verfasst, sie sieht nicht aus wie die Sprache der Erbauer, aber vielleicht kann mir Myxir trotzdem weiterhelfen.");
	FOUND_BOTTLE = TRUE;
};


instance ITWR_HEILUNG(C_Item)
{
	name = "Rezept";
	mainflag = ITEM_KAT_DOCS;
	flags = ITEM_MISSION;
...
func void use_vampi()
{
	...
	Doc_PrintLine (nDocID, 0, "");
	Doc_PrintLine (nDocID, 0, "");
	Doc_PrintLine (nDocID, 0, "Um die Vampirkrankheit zu");
	Doc_PrintLine (nDocID, 0, "heilen vermischt man folgende");
	Doc_PrintLine (nDocID, 0, "Zutaten an einem Alchemietisch:");
	Doc_PrintLine (nDocID, 0, "");
	Doc_PrintLine (nDocID, 0, "2 Minecrawlerzangen");
	Doc_PrintLine (nDocID, 0, "1 Horn eines Drachensnappers");
	Doc_PrintLine (nDocID, 0, "2 Flaschen Milch");
	Doc_PrintLine (nDocID, 0, "5 Feuerwurzeln");
	Doc_PrintLine (nDocID, 0, "1 Herz eines Dämons");
	Doc_PrintLine (nDocID, 0, "");
	Doc_SetMargins (nDocID, -1, 200, 50, 50, 50, 1);
	Doc_Show (nDocID);
	SC_CAN_HEAL_VAMPI = TRUE;
};


instance ITWR_DROHDING(C_Item)
{
	name = "Zettel";
	mainflag = ITEM_KAT_DOCS;
	flags = ITEM_MISSION;
	...
	visual = "ItWr_Scroll_01.3DS";
	material = MAT_LEATHER;
	on_state[0] = use_drohding;
	scemeName = "MAP";
	description = "Zettel";
};


func void use_drohding()
{
	var int nDocID;
	nDocID = Doc_Create ();
	Doc_SetPages (nDocID, 1);
	...
	Doc_PrintLine (nDocID, 0, "");
	Doc_PrintLine (nDocID, 0, "");
	Doc_PrintLine (nDocID, 0, "Cassia!");
	Doc_PrintLine (nDocID, 0, "Wenn du noch einmal in meine Angelegenheiten");
	Doc_PrintLine (nDocID, 0, "pfuschst dann wirst du es wirklich bereuen! ");
	Doc_PrintLine (nDocID, 0, "");
	Doc_PrintLine (nDocID, 0, "Ich hoffe diese Drohung ist unmissverständlich!");
	Doc_PrintLine (nDocID, 0, "");
	Doc_PrintLine (nDocID, 0, "");
	Doc_PrintLine (nDocID, 0, "");
	Doc_PrintLine (nDocID, 0, "");
...
instance ITWR_PASSARDOC(C_Item)
{
	name = "Passierschein";
	mainflag = ITEM_KAT_DOCS;
	flags = ITEM_MISSION;
	...
	visual = "ItWr_Scroll_01.3DS";
	material = MAT_LEATHER;
	on_state[0] = use_passardoc;
	scemeName = "MAP";
	description = "Passierschein";
};


func void use_passardoc()
{
	var int nDocID;
	nDocID = Doc_Create ();
	Doc_SetPages (nDocID, 1);
	...
	Doc_PrintLine (nDocID, 0, "");
	Doc_PrintLine (nDocID, 0, "");
	Doc_PrintLine (nDocID, 0, "Dem Träger dieses Dokuments sei");
	Doc_PrintLine (nDocID, 0, "der Zutritt zum Oberen Viertel und");
	Doc_PrintLine (nDocID, 0, "damit auch zu mir gestattet");
	Doc_PrintLine (nDocID, 0, "");
	Doc_PrintLine (nDocID, 0, "");
	Doc_PrintLine (nDocID, 0, "Ardoc Kahr");
	Doc_SetMargins (nDocID, -1, 200, 50, 50, 50, 1);
	Doc_Show (nDocID);
};
